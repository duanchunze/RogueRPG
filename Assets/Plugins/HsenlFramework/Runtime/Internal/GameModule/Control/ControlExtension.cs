...
namespace Hsenl {
    public static class ControlExtension {
        ...
        public static void SetValue<T>(this Control self, T controlCode, Vector3 val) where T : Enum => self.SetValue(controlCode.GetHashCode(), val);
        ...
        public static bool GetValue<T>(this Control self, T controlCode, out Vector3 result) where T : Enum =>

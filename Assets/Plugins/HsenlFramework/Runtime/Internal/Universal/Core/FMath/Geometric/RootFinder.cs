    ...
    public static class RootFinder {
        private class PolyRootFinder {
            ...
            public bool Bisection(Polynomial poly, FLOAT xMin, FLOAT xMax, int digits, out FLOAT root) {
                ...
                FLOAT num3 = Math.Log(xMax - xMin);
                FLOAT num4 = (FLOAT)digits * Math.Log(10f);
                FLOAT num5 = (num3 + num4) / Math.Log(2f);
        ...
        private static FLOAT sqrt3 = Math.Sqrt(3f);
        ...
        public static bool BrentsMethod(Func<FLOAT, FLOAT> function, FLOAT x0, FLOAT x1, out BrentsRoot root,
            ...
            for (i = 0; i < maxIterations; i++) {
                ...
                FLOAT num16 = Math.Abs(num15);
                FLOAT num17 = Math.Abs(x1 - num4);
                FLOAT num18 = Math.Abs(num4 - num5);
                // bool flag2 = false;
                if (num14 * num15 > 0f ||
                    ((!flag)
                ...
                if (Math.Abs(x1 - x0) <= segmentTolerance) {
                    root.x = x1;
                    root.iterations = i;
                    return true;
                }
        ...
        public static bool Cubic(FLOAT c0, FLOAT c1, FLOAT c2, FLOAT c3, out CubicRoots roots) {
            ...
            if (num6 > 0f) {
                ...
                if (num7 >= 0f) {
                    roots.x0 = Math.Pow(num7, 0.333333343f);
                }
                else {
                    roots.x0 = 0f - Math.Pow(0f - num7, 0.333333343f);
                }
                ...
                if (num7 >= 0f) {
                    ...
                    roots.x0 -= Math.Pow(0f - num7, 0.333333343f);
                }
                ...
                FLOAT num8 = Math.Sqrt(-0.333333343f * num3);
                FLOAT f = 0.333333343f * Math.Atan2(Math.Sqrt(0f - num6), 0f - num5);
                FLOAT num9 = Math.Cos(f);
                FLOAT num10 = Math.Sin(f);
                ...
                FLOAT num11 = ((!(num5 >= 0f))
                    ? Math.Pow(0f - num5, 0.333333343f)
                    : (0f - Math.Pow(num5, 0.333333343f)));
        ...
        public static FLOAT PolynomialBound(Polynomial poly) {
            ...
            for (int i = 0; i < degree; i++) {
                FLOAT num3 = Math.Abs(polynomial[i]) * num;
                if (num3 > num2) {
                    num2 = num3;
                }
            }

...
namespace Hsenl {
    ...
    public static class Intersection {
        ...
        public static bool TestBox2Box2(ref Box2D box0, ref Box2D box1) {
            ...
            FLOAT num = Math.Abs(axis.Dot(axis3));
            FLOAT num2 = Math.Abs(axis.Dot(axis4));
            FLOAT num3 = Math.Abs(axis.Dot(value));
            FLOAT num4 = x + x2 * num + y2 * num2;
            if (num3 > num4) {
                return false;
            }

            FLOAT num5 = Math.Abs(axis2.Dot(axis3));
            FLOAT num6 = Math.Abs(axis2.Dot(axis4));
            num3 = Math.Abs(axis2.Dot(value));
            num4 = y + x2 * num5 + y2 * num6;
            if (num3 > num4) {
                return false;
            }

            num3 = Math.Abs(axis3.Dot(value));
            num4 = x2 + x * num + y * num5;
            if (num3 > num4) {
                return false;
            }

            num3 = Math.Abs(axis4.Dot(value));
        ...
        public static bool FindCircle2Circle2(ref Circle2D circle0, ref Circle2D circle1, out Circle2Circle2Intr info) {
            ...
            Vector2 vector = circle1.center - circle0.center;
            FLOAT sqrMagnitude = vector.sqrMagnitude;
            FLOAT radius = circle0.radius;
            FLOAT radius2 = circle1.radius;
            FLOAT num = radius - radius2;
            if (sqrMagnitude < 9.99999944E-11f && Math.Abs(num) < 1E-05f) {
            ...
            if (sqrMagnitude < num4) {
                if (num2 < sqrMagnitude) {
                    ...
                    Vector2 vector2 = circle0.center + num6 * vector;
                    FLOAT num7 = radius * radius * num5 - num6 * num6;
                    if (num7 < 0f) {
                        num7 = 0f;
                    }

                    FLOAT num8 = Math.Sqrt(num7);
        ...
        private static int WhichSide(Polygon2D V, Vector2 P, ref Vector2 D) {
            int num = 0;
            int num2 = 0;
            int num3 = 0;
        ...
        public static bool TestConvexPolygon2ConvexPolygon2(Polygon2D convexPolygon0, Polygon2D convexPolygon1) {
            ...
            for (; i < convexPolygon0.vertexCount; i++) {
                Vector2 d = (convexPolygon0[i] - convexPolygon0[vertexIndex]).Perpendicular();
            ...
            for (; j < convexPolygon1.vertexCount; j++) {
                Vector2 d = (convexPolygon1[j] - convexPolygon1[vertexIndex2]).Perpendicular();
        ...
        private static bool DoClipping(FLOAT t0, FLOAT t1, ref Vector2 origin, ref Vector2 direction,
            ref AABB2D box, bool solid, out int quantity, out Vector2 point0, out Vector2 point1,
            out IntersectionTypes intrType) {
            box.CalcCenterExtents(out var center, out var extents);
            Vector2 vector = new Vector2(origin.x - center.x, origin.y - center.y);
            FLOAT num = t0;
            FLOAT num2 = t1;
        ...
        public static bool TestLine2AABB2(ref Line2D line, ref AABB2D box) {
            Vector2 vector = line.direction.Perpendicular();
        ...
        private static bool DoClipping(FLOAT t0, FLOAT t1, ref Vector2 origin, ref Vector2 direction, ref Box2D box,
            bool solid, out int quantity, out Vector2 point0, out Vector2 point1,
            out IntersectionTypes intrType) {
        ...
        public static bool TestLine2Box2(ref Line2D line, ref Box2D box) {
            Vector2 value = line.origin - box.center;
            Vector2 vector = line.direction.Perpendicular();
            FLOAT num = Math.Abs(vector.Dot(value));
            FLOAT num2 = Math.Abs(vector.Dot(box.axis0));
            FLOAT num3 = Math.Abs(vector.Dot(box.axis1));
        ...
        private static bool Find(ref Vector2 origin, ref Vector2 direction, ref Vector2 center, FLOAT radius,
        ...
        public static bool TestLine2Circle2(ref Line2D line, ref Circle2D circle) {
            Vector2 rhs = line.origin - circle.center;
            FLOAT num = rhs.sqrMagnitude - circle.radius * circle.radius;
            if (num <= 1E-05f) {
                return true;
            }

            Vector2.Dot(ref line.direction, ref rhs, out var num2);
            FLOAT num3 = num2 * num2 - num;
            return num3 >= -1E-05f;
        }
        ...
        private static IntersectionTypes Classify(ref Line2D line0, ref Line2D line1, out FLOAT s0) {
            Vector2 vector = line1.origin - line0.origin;
            s0 = 0f;
            FLOAT num = line0.direction.DotPerpendicular(line1.direction);
            if (Math.Abs(num) > _dotThreshold) {
        ...
        private static IntersectionTypes Classify(ref Line2D line, ref Ray2D ray, out FLOAT s0, out FLOAT s1) {
            Vector2 vector = ray.origin - line.origin;
            s0 = (s1 = 0f);
        ...
        private static IntersectionTypes Classify(ref Segment2D segment, ref Line2D line, out FLOAT s0, out FLOAT s1) {
            Vector2 vector = segment.center - line.origin;
            s0 = (s1 = 0f);
        ...
        public static bool TestLine2Segment2(ref Line2D line, ref Segment2D segment,
            ...
            if (intersectionType == IntersectionTypes.Point && !(Math.Abs(s2) <= segment.extent)) {
                intersectionType = IntersectionTypes.Empty;
            }
        ...
        public static bool FindLine2Segment2(ref Line2D line, ref Segment2D segment, out Line2Segment2Intr info) {
            ...
            info.Parameter = 0f;
            if (info.IntersectionType == IntersectionTypes.Point) {
                if (Math.Abs(s2) <= segment.extent + _intervalThreshold) {
                    info.Point = line.origin + s * line.direction;
                    info.Parameter = s;
                }
                else {
        ...
        private static void TriangleLineRelations(ref Vector2 origin, ref Vector2 direction,
        ...
        private static bool GetInterval(ref Vector2 origin, ref Vector2 direction, ref Triangle2D triangle,
        ...
        public static bool TestRay2AABB2(ref Ray2D ray, ref AABB2D box) {
            box.CalcCenterExtents(out var center, out var extents);
            Vector2 value = ray.origin - center;
            FLOAT x = ray.direction.x;
            FLOAT x2 = value.x;
            FLOAT num = Math.Abs(x2);
            ...
            FLOAT y2 = value.y;
            FLOAT num2 = Math.Abs(y2);
            if (num2 > extents.y && y2 * y >= 0f) {
                return false;
            }

            Vector2 vector = ray.direction.Perpendicular();
            FLOAT num3 = Math.Abs(vector.Dot(value));
            FLOAT num4 = Math.Abs(vector.x);
            FLOAT num5 = Math.Abs(vector.y);
        ...
        public static bool TestRay2Box2(ref Ray2D ray, ref Box2D box) {
            Vector2 vector = ray.origin - box.center;
            ...
            Vector2 vector2 = ray.direction.Perpendicular();
            FLOAT num7 = Math.Abs(vector2.Dot(vector));
            FLOAT num8 = Math.Abs(vector2.Dot(box.axis0));
            FLOAT num9 = Math.Abs(vector2.Dot(box.axis1));
        ...
        public static bool TestRay2Circle2(ref Ray2D ray, ref Circle2D circle) {
            Vector2 rhs = ray.origin - circle.center;
            FLOAT num = rhs.sqrMagnitude - circle.radius * circle.radius;
            if (num <= 1E-05f) {
                return true;
            }

            Vector2.Dot(ref ray.direction, ref rhs, out var num2);
            if (num2 >= 0f) {
                return false;
            }
        ...
        private static IntersectionTypes Classify(ref Ray2D ray0, ref Ray2D ray1, out FLOAT s0, out FLOAT s1) {
            Vector2 vector = ray1.origin - ray0.origin;
            s0 = (s1 = 0f);
            ...
            if (Math.Abs(f) <= _dotThreshold) {
                ...
                Vector2.Dot(ref dir, ref ray0.direction, out s0);
                return IntersectionTypes.Ray;
            }
        ...
        public static bool TestRay2Ray2(ref Ray2D ray0, ref Ray2D ray1, out IntersectionTypes intersectionType) {
            ...
            if (intersectionType == IntersectionTypes.Point) {
                ...
                if (Math.Abs(s) == 0f) {
                    Vector2.Dot(ref ray0.direction, ref ray1.direction, out var num);
                    if (num < 0f) {
                        intersectionType = IntersectionTypes.Point;
                    }
                }
                else if (s < 0f) {
                    Vector2.Dot(ref ray0.direction, ref ray1.direction, out var num2);
                    if (num2 < 0f) {
                        intersectionType = IntersectionTypes.Empty;
                    }
                }
        ...
        private static IntersectionTypes Classify(ref Ray2D ray, ref Segment2D segment, out FLOAT s0, out FLOAT s1) {
            Vector2 vector = segment.center - ray.origin;
            s0 = (s1 = 0f);
            ...
            if (Math.Abs(f) <= _dotThreshold) {
                ...
                Vector2.Dot(ref dir1, ref ray.direction, out s0);
                Vector2.Dot(ref dir2, ref ray.direction, out s1);
                if (s0 > s1) {
                    FLOAT num5 = s0;
                    s0 = s1;
                    s1 = num5;
        ...
        public static bool TestRay2Segment2(ref Ray2D ray, ref Segment2D segment,
            ...
            if (intersectionType == IntersectionTypes.Point) {
                if (!(s >= 0f - _intervalThreshold) || !(Math.Abs(s2) <= segment.extent + _intervalThreshold)) {
                    intersectionType = IntersectionTypes.Empty;
                }
            }
        ...
        public static bool FindRay2Segment2(ref Ray2D ray, ref Segment2D segment, out Ray2Segment2Intr info) {
            ...
            if (info.IntersectionType == IntersectionTypes.Point) {
                if (s >= 0f - _intervalThreshold && Math.Abs(s2) <= segment.extent) {
        ...
        public static bool TestSegment2AABB2(ref Segment2D segment, ref AABB2D box) {
            box.CalcCenterExtents(out var center, out var extents);
            Vector2 value = segment.center - center;
            FLOAT num = Math.Abs(segment.direction.x);
            FLOAT num2 = Math.Abs(value.x);
            FLOAT num3 = extents.x + segment.extent * num;
            if (num2 > num3) {
                return false;
            }

            FLOAT num4 = Math.Abs(segment.direction.y);
            FLOAT num5 = Math.Abs(value.y);
            num3 = extents.y + segment.extent * num4;
            if (num5 > num3) {
                return false;
            }

            Vector2 vector = segment.direction.Perpendicular();
            FLOAT num6 = Math.Abs(vector.Dot(value));
            FLOAT num7 = Math.Abs(vector.x);
            FLOAT num8 = Math.Abs(vector.y);
        ...
        public static bool TestSegment2Box2(ref Segment2D segment, ref Box2D box) {
            ...
            FLOAT num = Math.Abs(segment.direction.Dot(box.axis0));
            FLOAT num2 = Math.Abs(vector.Dot(box.axis0));
            ...
            FLOAT num4 = Math.Abs(segment.direction.Dot(box.axis1));
            FLOAT num5 = Math.Abs(vector.Dot(box.axis1));
            num3 = box.extents.y + segment.extent * num4;
            if (num5 > num3) {
                return false;
            }

            Vector2 vector2 = segment.direction.Perpendicular();
            FLOAT num6 = Math.Abs(vector2.Dot(vector));
            FLOAT num7 = Math.Abs(vector2.Dot(box.axis0));
            FLOAT num8 = Math.Abs(vector2.Dot(box.axis1));
        ...
        public static bool TestSegment2Circle2(ref Segment2D segment, ref Circle2D circle) {
            ...
            Vector2.Dot(ref segment.direction, ref rhs, out var num2);
            FLOAT num3 = num2 * num2 - num;
            if (num3 < -1E-05f) {
                return false;
            }
        ...
        public static bool FindSegment2Circle2(ref Segment2D segment, ref Circle2D circle,
            ...
            if (flag) {
                if (rootCount == 1) {
                    if (Math.Abs(t) > segment.extent + 1E-05f) {
                        info.IntersectionType = IntersectionTypes.Empty;
                    }
                    else {
                        info.IntersectionType = IntersectionTypes.Point;
        ...
        private static IntersectionTypes Classify(ref Segment2D segment0, ref Segment2D segment1, out FLOAT s0,
            ...
            if (Math.Abs(f) <= _dotThreshold) {
                ...
                Vector2.Dot(ref dir1, ref segment0.direction, out s0);
                Vector2.Dot(ref dir2, ref segment0.direction, out s1);
                if (s0 > s1) {
                    (s0, s1) = (s1, s0);
                }
        ...
        public static bool TestSegment2Segment2(ref Segment2D segment0, ref Segment2D segment1,
            ...
            if (intersectionType == IntersectionTypes.Point) {
                if (!(Math.Abs(s) <= segment0.extent + _intervalThreshold) ||
                    !(Math.Abs(s2) <= segment1.extent + _intervalThreshold)) {
                    intersectionType = IntersectionTypes.Empty;
                }
            }
            else if (intersectionType == IntersectionTypes.Segment) {
        ...
        private static int WhichSide(ref Triangle2D triangle, ref Vector2 P, ref Vector2 D) {
            int num = 0;
            int num2 = 0;
            int num3 = 0;
        ...
        private static void ClipConvexPolygonAgainstLine(ref Vector2 edgeStart, ref Vector2 edgeEnd,
            ...
            int num11 = ((Math.Abs(vector.y) > Math.Abs(vector.x)) ? 1 : 0);
            ...
            if (num14 > 0) {
                if (num11 == 0) {
                    info.Point0 = new Vector2((num - vector.y * w) / vector.x, w);
                    if (num14 == 2) {
                        info.Point1 = new Vector2((num - vector.y * w2) / vector.x, w2);
                    }
                }
                else {
                    info.Point0 = new Vector2(w, (num - vector.x * w) / vector.y);
                    if (num14 == 2) {
                        info.Point1 = new Vector2(w2, (num - vector.x * w2) / vector.y);
                    }
                }
        ...
        public static bool TestTriangle2Triangle2(ref Triangle2D triangle0, ref Triangle2D triangle1) {
            Vector2 p = triangle0.v0;
            Vector2 v = triangle0.v1;
        ...
        public static bool TestBox3Box3(ref Box box0, ref Box box1) {
            ...
            FLOAT num13 = Math.Abs(num12);
            if (num13 > num) {
                flag = true;
            }

            FLOAT num14 = axis2.Dot(axis5);
            FLOAT num15 = Math.Abs(num14);
            if (num15 > num) {
                flag = true;
            }

            FLOAT num16 = axis2.Dot(axis6);
            FLOAT num17 = Math.Abs(num16);
            if (num17 > num) {
                flag = true;
            }
            ...
            num9 = Math.Abs(num25 * num12 - num18 * num19);
            ...
            num9 = Math.Abs(num25 * num14 - num18 * num21);
            ...
            num9 = Math.Abs(num25 * num16 - num18 * num23);
            ...
            num9 = Math.Abs(num8 * num19 - num25 * num2);
            ...
            num9 = Math.Abs(num8 * num21 - num25 * num4);
            ...
            num9 = Math.Abs(num8 * num23 - num25 * num6);
            ...
            num9 = Math.Abs(num18 * num2 - num8 * num12);
            ...
            num9 = Math.Abs(num18 * num4 - num8 * num14);
            ...
            num9 = Math.Abs(num18 * num6 - num8 * num16);
        ...
        private static bool DoClipping(FLOAT t0, FLOAT t1, ref Vector3 origin, ref Vector3 direction, ref AABB box,
            bool solid, out int quantity, out Vector3 point0, out Vector3 point1,
            out IntersectionTypes intrType) {
            box.CalcCenterExtents(out var center, out var extents);
            Vector3 vector = new Vector3(origin.x - center.x, origin.y - center.y, origin.z - center.z);
            FLOAT num = t0;
            FLOAT num2 = t1;
            if (Clip(direction.x, 0f - vector.x - extents.x, ref t0, ref t1) &&
                Clip(0f - direction.x, vector.x - extents.x, ref t0, ref t1) &&
        ...
        public static bool TestLine3AABB3(ref Line line, ref AABB box) {
            box.CalcCenterExtents(out var center, out var extents);
            Vector3 value = line.origin - center;
            Vector3 vector = line.direction.Cross(value);
            FLOAT num = Math.Abs(line.direction.y);
            FLOAT num2 = Math.Abs(line.direction.z);
            FLOAT num3 = Math.Abs(vector.x);
            FLOAT num4 = extents.y * num2 + extents.z * num;
            if (num3 > num4) {
                return false;
            }

            FLOAT num5 = Math.Abs(line.direction.x);
            FLOAT num6 = Math.Abs(vector.y);
            num4 = extents.x * num2 + extents.z * num5;
            if (num6 > num4) {
                return false;
            }

            FLOAT num7 = Math.Abs(vector.z);
        ...
        private static bool DoClipping(FLOAT t0, FLOAT t1, ref Vector3 origin, ref Vector3 direction, ref Box box,
            bool solid, out int quantity, out Vector3 point0, out Vector3 point1,
            out IntersectionTypes intrType) {
            ...
            Vector3 vector3 = new Vector3(direction.Dot(box.axis0), direction.Dot(box.axis1),
        ...
        public static bool TestLine3Box3(ref Line line, ref Box box) {
            Vector3 value = line.origin - box.center;
            Vector3 vector = line.direction.Cross(value);
            FLOAT num = Math.Abs(line.direction.Dot(box.axis1));
            FLOAT num2 = Math.Abs(line.direction.Dot(box.axis2));
            FLOAT num3 = Math.Abs(vector.Dot(box.axis0));
            FLOAT num4 = box.extents.y * num2 + box.extents.z * num;
            if (num3 > num4) {
                return false;
            }

            FLOAT num5 = Math.Abs(line.direction.Dot(box.axis0));
            FLOAT num6 = Math.Abs(vector.Dot(box.axis1));
            num4 = box.extents.x * num2 + box.extents.z * num5;
            if (num6 > num4) {
                return false;
            }

            FLOAT num7 = Math.Abs(vector.Dot(box.axis2));
        ...
        public static bool TestLine3Plane3(ref Line line, ref Plane plane, out IntersectionTypes intersectionType) {
            ...
            if (Math.Abs(f2) <= _distanceThreshold) {
        ...
        public static bool FindLine3Plane3(ref Line line, ref Plane plane, out Line3Plane3Intr info) {
            ...
            if (Math.Abs(num2) <= _distanceThreshold) {
        ...
        public static bool FindLine3Polygon3(ref Line line, Polygon polygon, out Line3Polygon3Intr info) {
            ...
            if (Math.Abs(num) > _dotThreshold) {
                ...
                Vector2 point = vector.ToFVector2(projectionPlane);
        ...
        private static bool Point3InsideRectangle3(ref Vector3 point, ref Rectangle rectangle) {
        ...
        public static bool TestLine3Sphere3(ref Line line, ref Sphere sphere) {
            Vector3 value = line.origin - sphere.center;
        ...
        public static bool FindLine3Sphere3(ref Line line, ref Sphere sphere, out Line3Sphere3Intr info) {
            Vector3 vector = line.origin - sphere.center;
        ...
        public static bool TestLine3Triangle3(ref Line line, ref Triangle triangle,
            out IntersectionTypes intersectionType) {
            Vector3 vector = line.origin - triangle.v0;
        ...
        /// Tests if a line intersects a triangle. Returns true if intersection occurs false otherwise.
        /// </summary>
        public static bool TestLine3Triangle3(ref Line line, ref Vector3 v0, ref Vector3 v1, ref Vector3 v2,
            out IntersectionTypes intersectionType) {
        ...
        /// Tests if a line intersects a triangle. Returns true if intersection occurs false otherwise.
        /// </summary>
        public static bool TestLine3Triangle3(ref Line line, Vector3 v0, Vector3 v1, Vector3 v2,
            out IntersectionTypes intersectionType) {
            Triangle triangle = default(Triangle);
            triangle.v0 = v0;
            triangle.v1 = v1;
        ...
        /// Tests if a line intersects a triangle and finds intersection parameters. Returns true if intersection occurs false otherwise.
        /// </summary>
        public static bool FindLine3Triangle3(ref Line line, ref Vector3 v0, ref Vector3 v1, ref Vector3 v2,
        ...
        /// Tests if a line intersects a triangle and finds intersection parameters. Returns true if intersection occurs false otherwise.
        /// </summary>
        public static bool FindLine3Triangle3(ref Line line, Vector3 v0, Vector3 v1, Vector3 v2,
            out Line3Triangle3Intr info) {
            Triangle triangle = default(Triangle);
            triangle.v0 = v0;
            triangle.v1 = v1;
        ...
        public static bool TestPlane3Sphere3(ref Plane plane, ref Sphere sphere) {
            ...
            return Math.Abs(f) <= sphere.radius + 1E-05f;
        }
        ...
        public static bool FindPlane3Sphere3(ref Plane plane, ref Sphere sphere, out Plane3Sphere3Intr info) {
            ...
            if (num2 <= sphere.radius + 1E-05f) {
                if (num2 >= sphere.radius - 1E-05f) {
                    ...
                    Vector3 center = sphere.center - num * plane.normal;
                    FLOAT radius = Math.Sqrt(Math.Abs(sphere.radius * sphere.radius - num2 * num2));
                    info.IntersectionType = IntersectionTypes.Other;
        ...
        public static bool TestPlane3Triangle3(ref Plane plane, ref Triangle triangle) {
            ...
            if (Math.Abs(num3) <= _distanceThreshold) {
                num3 = num;
            }

            FLOAT num4 = plane.SignedDistanceTo(ref triangle.v2);
            if (Math.Abs(num4) <= _distanceThreshold) {
                num4 = num;
            }
        ...
        public static bool TestRay3AABB3(ref Ray ray, ref AABB box) {
            box.CalcCenterExtents(out var center, out var extents);
            Vector3 value = ray.origin - center;
            FLOAT x = ray.direction.x;
            FLOAT num = Math.Abs(x);
            FLOAT x2 = value.x;
            FLOAT num2 = Math.Abs(x2);
            ...
            FLOAT y2 = value.y;
            FLOAT num4 = Math.Abs(y2);
            if (num4 > extents.y && y2 * y >= 0f) {
                return false;
            }

            FLOAT z = ray.direction.z;
            FLOAT num5 = Math.Abs(z);
            FLOAT z2 = value.z;
            FLOAT num6 = Math.Abs(z2);
            if (num6 > extents.z && z2 * z >= 0f) {
                return false;
            }

            Vector3 vector = ray.direction.Cross(value);
            FLOAT num7 = Math.Abs(vector.x);
            ...
            FLOAT num9 = Math.Abs(vector.y);
            num8 = extents.x * num5 + extents.z * num;
            if (num9 > num8) {
                return false;
            }

            FLOAT num10 = Math.Abs(vector.z);
        ...
        public static bool TestRay3Box3(ref Ray ray, ref Box box) {
            Vector3 vector = ray.origin - box.center;
            FLOAT num = ray.direction.Dot(box.axis0);
            FLOAT num2 = Math.Abs(num);
            ...
            FLOAT num13 = Math.Abs(vector2.Dot(box.axis0));
            FLOAT num14 = box.extents.y * num10 + box.extents.z * num6;
            if (num13 > num14) {
                return false;
            }

            FLOAT num15 = Math.Abs(vector2.Dot(box.axis1));
            num14 = box.extents.x * num10 + box.extents.z * num2;
            if (num15 > num14) {
                return false;
            }

            FLOAT num16 = Math.Abs(vector2.Dot(box.axis2));
        ...
        public static bool FindRay3Circle3(ref Ray ray, ref Circle circle, out Ray3Circle3Intr info) {
            ...
            if (Math.Abs(num) > _dotThreshold) {
                ...
                if (num3 >= 0f - _intervalThreshold) {
                    Vector3 vector = ray.origin + num3 * ray.direction;
                    if ((vector - circle.center).sqrMagnitude <= circle.radius * circle.radius) {
                        info.IntersectionType = IntersectionTypes.Point;
                        info.Point = vector;
                        return true;
        ...
        public static bool FindRay3Rectangle3(ref Ray ray, ref Rectangle rectangle, out Ray3Rectangle3Intr info) {
            ...
            if (Math.Abs(num) > _dotThreshold) {
                ...
                FLOAT num3 = (0f - num2) / num;
                if (num3 >= 0f - _intervalThreshold) {
                    Vector3 point = ray.origin + num3 * ray.direction;
                    if (Point3InsideRectangle3(ref point, ref rectangle)) {
                        info.IntersectionType = IntersectionTypes.Point;
                        info.Point = point;
                        return true;
        ...
        public static bool TestRay3Triangle3(ref Ray ray, ref Triangle triangle,
            out IntersectionTypes intersectionType) {
            Vector3 vector = ray.origin - triangle.v0;
            Vector3 vector2 = triangle.v1 - triangle.v0;
            Vector3 value = triangle.v2 - triangle.v0;
            Vector3 value2 = vector2.Cross(value);
        ...
        /// Tests if a ray intersects a triangle. Returns true if intersection occurs false otherwise.
        /// </summary>
        public static bool TestRay3Triangle3(ref Ray ray, ref Vector3 v0, ref Vector3 v1, ref Vector3 v2,
            out IntersectionTypes intersectionType) {
            Triangle triangle = default(Triangle);
            triangle.v0 = v0;
            triangle.v1 = v1;
        ...
        /// Tests if a ray intersects a triangle. Returns true if intersection occurs false otherwise.
        /// </summary>
        public static bool TestRay3Triangle3(ref Ray ray, Vector3 v0, Vector3 v1, Vector3 v2,
            out IntersectionTypes intersectionType) {
            Triangle triangle = default(Triangle);
            triangle.v0 = v0;
            triangle.v1 = v1;
        ...
        /// Tests if a ray intersects a triangle and finds intersection parameters. Returns true if intersection occurs false otherwise.
        /// </summary>
        public static bool FindRay3Triangle3(ref Ray ray, ref Vector3 v0, ref Vector3 v1, ref Vector3 v2,
        ...
        /// Tests if a ray intersects a triangle and finds intersection parameters. Returns true if intersection occurs false otherwise.
        /// </summary>
        public static bool FindRay3Triangle3(ref Ray ray, Vector3 v0, Vector3 v1, Vector3 v2,
            out Ray3Triangle3Intr info) {
            Triangle triangle = default(Triangle);
            triangle.v0 = v0;
            triangle.v1 = v1;
        ...
        public static bool TestSegment3AABB3(ref Segment segment, ref AABB box) {
            box.CalcCenterExtents(out var center, out var extents);
            Vector3 value = segment.center - center;
            FLOAT num = Math.Abs(segment.direction.x);
            FLOAT num2 = Math.Abs(value.x);
            FLOAT num3 = extents.x + segment.extent * num;
            if (num2 > num3) {
            ...
            FLOAT num6 = Math.Abs(segment.direction.z);
            FLOAT num7 = Math.Abs(value.z);
            num3 = extents.z + segment.extent * num6;
            if (num7 > num3) {
                return false;
            }

            Vector3 vector = segment.direction.Cross(value);
            FLOAT num8 = Math.Abs(vector.x);
        ...
        public static bool TestSegment3Box3(ref Segment segment, ref Box box) {
            ...
            FLOAT num6 = Math.Abs(segment.direction.Dot(box.axis2));
            FLOAT num7 = Math.Abs(vector.Dot(box.axis2));
            ...
            FLOAT num10 = Math.Abs(vector2.Dot(box.axis2));
        ...
        public static bool FindSegment3Circle3(ref Segment segment, ref Circle circle, out Segment3Circle3Intr info) {
            ...
            if (Math.Abs(num) > _dotThreshold) {
                ...
                FLOAT num3 = (0f - num2) / num;
                if (Math.Abs(num3) <= segment.extent + _intervalThreshold) {
        ...
        public static bool TestSegment3Plane3(ref Segment segment, ref Plane plane,
            out IntersectionTypes intersectionType) {
            Vector3 point = segment.p0;
            FLOAT num = plane.SignedDistanceTo(ref point);
            if (Math.Abs(num) <= _distanceThreshold) {
                num = 0f;
            }

            Vector3 point2 = segment.p1;
        ...
        public static bool TestSegment3Sphere3(ref Segment segment, ref Sphere sphere) {
            ...
            if (num6 > 0f) {
                return Math.Abs(num2) < segment.extent;
            }
        ...
        public static bool FindSegment3Sphere3(ref Segment segment, ref Sphere sphere, out Segment3Sphere3Intr info) {
            ...
            if (num6 > 0f && Math.Abs(num2) < segment.extent) {
                if (num3 >= 1E-05f) {
                    FLOAT num8 = Math.Sqrt(num3);
        ...
        /// Tests if a segment intersects a triangle. Returns true if intersection occurs false otherwise.
        /// </summary>
        public static bool TestSegment3Triangle3(ref Segment segment, ref Vector3 v0, ref Vector3 v1,
            ref Vector3 v2, out IntersectionTypes intersectionType) {
            Triangle triangle = default(Triangle);
            triangle.v0 = v0;
            triangle.v1 = v1;
            triangle.v2 = v2;
        ...
        /// Tests if a segment intersects a triangle. Returns true if intersection occurs false otherwise.
        /// </summary>
        public static bool TestSegment3Triangle3(ref Segment segment, Vector3 v0, Vector3 v1, Vector3 v2,
            out IntersectionTypes intersectionType) {
            Triangle triangle = default(Triangle);
            triangle.v0 = v0;
            triangle.v1 = v1;
        ...
        /// Tests if a segment intersects a triangle and finds intersection parameters. Returns true if intersection occurs false otherwise.
        /// </summary>
        public static bool FindSegment3Triangle3(ref Segment segment, ref Vector3 v0, ref Vector3 v1,
            ref Vector3 v2, out Segment3Triangle3Intr info) {
            Triangle triangle = default(Triangle);
            triangle.v0 = v0;
            triangle.v1 = v1;
            triangle.v2 = v2;
        ...
        /// Tests if a segment intersects a triangle and finds intersection parameters. Returns true if intersection occurs false otherwise.
        /// </summary>
        public static bool FindSegment3Triangle3(ref Segment segment, Vector3 v0, Vector3 v1, Vector3 v2,
            out Segment3Triangle3Intr info) {
            Triangle triangle = default(Triangle);
            triangle.v0 = v0;
            triangle.v1 = v1;
        ...
        public static bool FindSphere3Sphere3(ref Sphere sphere0, ref Sphere sphere1, out Sphere3Sphere3Intr info) {
            ...
            Vector3 center = sphere0.center + num5 * normal;
            FLOAT radius3 = Math.Sqrt(Math.Abs(radius * radius - num5 * num5 * sqrMagnitude));
            normal.Normalize();
        ...
        private static bool IntersectsSegment(ref Plane plane, ref Triangle triangle, ref Vector3 end0,
            ref Vector3 end1, bool grazing, out Triangle3Triangle3Intr info) {
            int num = 0;
            FLOAT num2 = Math.Abs(plane.normal.x);
            FLOAT num3 = Math.Abs(plane.normal.y);
            if (num3 > num2) {
                num = 1;
                num2 = num3;
            }
            ...
            switch (num) {
                case 0: {
                    ...
                    info.Point0 =
                        new Vector3(num6 * (plane.constant - plane.normal.y * point.x - plane.normal.z * point.y),
                            point.x, point.y);
                    info.Point1 = ((info.Quantity == 2)
                        ? new Vector3(num6 * (plane.constant - plane.normal.y * vector.x - plane.normal.z * vector.y), vector.x,
                            vector.y)
                        : Vector3.Zero);
                    break;
                }
                case 1: {
                    ...
                    info.Point0 = new Vector3(point.x,
                ...
                default: {
                    ...
                    info.Point0 = new Vector3(point.x, point.y,
        ...
        private static int QueryToTriangle(ref Vector2 test, ref Vector2 v0, ref Vector2 v1,
            ref Vector2 v2) {
        ...
        private static bool ContainsPoint(ref Triangle triangle, ref Plane plane, ref Vector3 point,
            ...
            Vector2 test = new Vector2(u.Dot(value), v.Dot(value));
            Vector2 v2 = Vector2.Zero;
            Vector2 v3 = new Vector2(u.Dot(value2), v.Dot(value2));
            Vector2 v4 = new Vector2(u.Dot(value3), v.Dot(value3));
            ...
            switch (num) {
                case 0: {
                    ...
                    for (int j = 0; j < num4; j++) {
                        info[j] = new Vector3(num6 * (plane.constant - plane.normal.y * info2[j].x - plane.normal.z * info2[j].y),
                            info2[j].x, info2[j].y);
                    }
                ...
                default: {
                    ...
                    for (int i = 0; i < num4; i++) {
                        info[i] = new Vector3(info2[i].x, info2[i].y,
        ...
        public static bool TestTriangle3Triangle3(ref Triangle triangle0, ref Triangle triangle1,
            ...
            Vector3 axis = vector.NormalizeCross(vector2);
            ...
            Vector3 vector4 = triangle1.v1 - triangle1.v0;
            Vector3 value = triangle1.v2 - triangle1.v1;
            Vector3 value2 = triangle1.v0 - triangle1.v2;
            Vector3 axis2 = vector4.NormalizeCross(value);
            intersectionType = IntersectionTypes.Empty;
            Vector3 vector5 = axis.NormalizeCross(axis2);
            FLOAT fmin2;
            FLOAT fmax2;
            if (vector5.Dot(vector5) >= 1E-05f) {
                ...
                Vector3 axis3 = vector.NormalizeCross(vector4);
                ...
                Vector3 axis3 = axis.NormalizeCross(vector);
                ProjectOntoAxis(ref triangle0, ref axis3, out fmin2, out fmax2);
                ProjectOntoAxis(ref triangle1, ref axis3, out fmin, out fmax);
                if (fmax2 < fmin || fmax < fmin2) {
                    return false;
        ...
        public static bool FindTriangle3Triangle3(ref Triangle triangle0, ref Triangle triangle1,
            ...
            if (zero == 0) {
                ...
                if (sign == num) {
                    ...
                    Vector3 end = triangle1.v0 + num2 * (triangle1.v2 - triangle1.v0);
                    num2 = dist / (dist - dist2);
                    Vector3 end2 = triangle1.v0 + num2 * (triangle1.v1 - triangle1.v0);
                    return IntersectsSegment(ref plane, ref triangle0, ref end, ref end2, grazing: false, out info);
                }

                if (sign2 == num) {
                    FLOAT num2 = dist2 / (dist2 - dist);
                    Vector3 end = triangle1.v1 + num2 * (triangle1.v0 - triangle1.v1);
                    num2 = dist2 / (dist2 - dist3);
                    Vector3 end2 = triangle1.v1 + num2 * (triangle1.v2 - triangle1.v1);
                    return IntersectsSegment(ref plane, ref triangle0, ref end, ref end2, grazing: false, out info);
                }

                if (sign3 == num) {
                    FLOAT num2 = dist3 / (dist3 - dist2);
                    Vector3 end = triangle1.v2 + num2 * (triangle1.v1 - triangle1.v2);
                    num2 = dist3 / (dist3 - dist);
                    Vector3 end2 = triangle1.v2 + num2 * (triangle1.v0 - triangle1.v2);
                    return IntersectsSegment(ref plane, ref triangle0, ref end, ref end2, grazing: false, out info);
                }
            }
            else {

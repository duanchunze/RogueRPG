...
namespace Hsenl {
    public static class LinearSystem {
        ...
        /// <param name="zeroTolerance">Small positive number</param>
        /// <returns>True if solution is found, false otherwise</returns>
        public static bool Solve2(FLOAT[,] A, FLOAT[] B, out Vector2 X) {
            FLOAT zeroTolerance = 1E-05f;
            FLOAT[] X2;
        ...
        /// <param name="zeroTolerance">Small positive number</param>
        /// <returns>True if solution is found, false otherwise</returns>
        public static bool Solve2(FLOAT[,] A, FLOAT[] B, out Vector2 X, FLOAT zeroTolerance) {
            FLOAT[] X2;
            bool flag = Solve2(A, B, out X2, zeroTolerance);
            if (flag) {
                X.x = X2[0];
        ...
        /// <param name="zeroTolerance">Small positive number</param>
        /// <returns>True if solution is found, false otherwise</returns>
        public static bool Solve3(FLOAT[,] A, FLOAT[] B, out Vector3 X) {
            FLOAT zeroTolerance = 1E-05f;
            FLOAT[] X2;
        ...
        /// <param name="zeroTolerance">Small positive number</param>
        /// <returns>True if solution is found, false otherwise</returns>
        public static bool Solve3(FLOAT[,] A, FLOAT[] B, out Vector3 X, FLOAT zeroTolerance) {
            FLOAT[] X2;
            bool flag = Solve3(A, B, out X2, zeroTolerance);
            if (flag) {
                X.x = X2[0];

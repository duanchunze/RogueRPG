...
namespace Hsenl {
    ...
    public class FRandom {
        ...
        private static readonly FLOAT TwoPi = (FLOAT)(Math.Pi * 2.0);
        ...
        public FLOAT RandomAngleRadians() {
            return this.NextFloat() * (Math.Pi * 2f);
        }
        ...
        /// Generates a random point inside the square with specified side size.
        /// </summary>
        public Vector2 InSquare(FLOAT side) {
            FLOAT num = side * 0.5f;
            FLOAT min = 0f - num;
            return new Vector2(this.NextFloat(min, num), this.NextFloat(min, num));
        }
        ...
        /// Generates a random point on the border of the square with specified side size.
        /// </summary>
        public Vector2 OnSquare(FLOAT side) {
            FLOAT num = side * 0.5f;
            FLOAT num2 = 0f - num;
            switch (this.NextInt(0, 4)) {
                case 0:
        ...
        /// Generates a random point inside the cube with specified side size.
        /// </summary>
        public Vector3 InCube(FLOAT side) {
            FLOAT num = side * 0.5f;
            FLOAT min = 0f - num;
            return new Vector3(this.NextFloat(min, num), this.NextFloat(min, num), this.NextFloat(min, num));
        }
        ...
        /// Generates a random point on the surface of the cube with specified side size.
        /// </summary>
        public Vector3 OnCube(FLOAT side) {
            FLOAT num = side * 0.5f;
            FLOAT num2 = 0f - num;
            switch (this.NextInt(0, 6)) {
                case 0:
        ...
        public Vector2 InCircle() {
            FLOAT radius = 1f;
            FLOAT num = radius * Math.Sqrt(this.NextFloat());
            FLOAT f = this.RandomAngleRadians();
            return new Vector2(num * Math.Cos(f), num * Math.Sin(f));
        }
        ...
        public Vector2 InCircle(FLOAT radiusMin, FLOAT radiusMax) {
            ...
            FLOAT num2 = Math.Sqrt(2f * this.NextFloat() / num + radiusMin * radiusMin);
            FLOAT f = this.RandomAngleRadians();
            return new Vector2(num2 * Math.Cos(f), num2 * Math.Sin(f));
        }
        ...
        public Vector2 OnCircle() {
            FLOAT radius = 1f;
            FLOAT f = this.RandomAngleRadians();
            return new Vector2(Math.Cos(f) * radius, Math.Sin(f) * radius);
        }
        ...
        public Vector3 OnSphere() {
            ...
            FLOAT f = this.NextFloat() * ((FLOAT)Math.Pi * 2f);
            FLOAT num2 = Math.Sqrt(1f - num * num) * radius;
            return new Vector3(num2 * Math.Cos(f), num2 * Math.Sin(f), num * radius);
        }
        ...
        public Vector3 InTriangle(ref Vector3 v0, ref Vector3 v1, ref Vector3 v2) {
            FLOAT num = Math.Sqrt((FLOAT)this.NextDouble());
            ...
            return new Vector3(vector.x + vector2.x + vector3.x, vector.y + vector2.y + vector3.y,
        ...
        public Quaternion RandomRotation() {
            ...
            FLOAT num5 = Math.Sqrt((FLOAT)(1.0 - num));
            FLOAT d = (FLOAT)(Math.Pi * 2.0 * num2);
            FLOAT d2 = (FLOAT)(Math.Pi * 2.0 * num3);
            return new Quaternion((FLOAT)(num5 * Math.Sin(d)), (FLOAT)(num5 * Math.Cos(d)),
                (FLOAT)(num4 * Math.Sin(d2)), (FLOAT)(num4 * Math.Cos(d2)));
        }
    }
}
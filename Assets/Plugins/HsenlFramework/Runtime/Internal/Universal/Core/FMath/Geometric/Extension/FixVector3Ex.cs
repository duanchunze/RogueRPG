    ...
    public static class FVector3Ex {
        ...
        internal static Information GetInformation(IList<Vector3> points, FLOAT epsilon) {
            ...
            if (information.MaxRange < epsilon) {
                ...
                ref Vector3 reference = ref information.Direction[0];
                reference = Vector3.Zero;
                ref Vector3 reference2 = ref information.Direction[1];
                reference2 = Vector3.Zero;
                ref Vector3 reference3 = ref information.Direction[2];
                reference3 = Vector3.Zero;
                return information;
            }

            ref Vector3 reference4 = ref information.Direction[0];
            ...
            ref Vector3 reference5 = ref information.Direction[1];
            ...
            ref Vector3 reference6 = ref information.Direction[2];
            ...
            for (int k = 0; k < count; k++) {
                ...
                FLOAT num17 = Math.Sign(magnitude);
        ...
        /// </summary>
        public static Vector3 NormalizeCross(this Vector3 vector, Vector3 value) {
            Vector3 vector2 = new Vector3(vector.y * value.z - vector.z * value.y,
                vector.z * value.x - vector.x * value.z, vector.x * value.y - vector.y * value.x);
            Vector3.Normalize(ref vector2);
            return vector2;
        }
        ...
        /// </summary>
        public static Vector2 ToFVector2XY(this Vector3 vector) {
        ...
        /// </summary>
        public static Vector2 ToFVector2XZ(this Vector3 vector) {
        ...
        /// </summary>
        public static Vector2 ToFVector2YZ(this Vector3 vector) {
        ...
        /// </summary>
        public static Vector2 ToFVector2(this Vector3 vector, ProjectionPlanes projectionPlane) {
            return projectionPlane switch {
                ProjectionPlanes.XY => new Vector2(vector.x, vector.y),
                ProjectionPlanes.XZ => new Vector2(vector.x, vector.z),
                _ => new Vector2(vector.y, vector.z),
            };
        }
        ...
        public static ProjectionPlanes GetProjectionPlane(this Vector3 vector) {
            ...
            var num = Math.Abs(vector.x);
            var num2 = Math.Abs(vector.y);
            if (num2 > num) {
                result = ProjectionPlanes.XZ;
                num = num2;
            }

            num2 = Math.Abs(vector.z);
            if (num2 > num) {

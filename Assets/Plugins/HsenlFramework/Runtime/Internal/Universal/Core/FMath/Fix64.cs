    ...
    public partial struct Fixp : IEquatable<Fixp>, IComparable<Fixp> {
        ...
        internal static void GenerateAcosLut() {
            ...
            for (int i = 0; i < 205887; i++) {
                ...
                double num3 = System.Math.Acos(num2);
        ...
        internal static void GenerateSinLut() {
            ...
            int num = 0;
            for (int i = 0; i < 205887; i++) {
                double a = (double)i * System.Math.PI * 0.5 / 205886.0;
                if (num++ % 8 == 0) {
                    streamWriter.WriteLine();
                    streamWriter.Write("            ");
                }

                double num2 = System.Math.Sin(a);

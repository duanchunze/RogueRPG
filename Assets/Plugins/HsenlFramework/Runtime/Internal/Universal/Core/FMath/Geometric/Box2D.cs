...
namespace Hsenl {
    ...
    public struct Box2D {
        ...
        public Box2D(ref Vector2 center, ref Vector2 axis0, ref Vector2 axis1, ref Vector2 extents) {
            this.center = center;
            this.axis0 = axis0;
            this.axis1 = axis1;
        ...
        /// <param name="axis1">Second box axis. Must be unit length!</param>
        /// <param name="extents">Extents (half sizes) along Axis0 and Axis1. Must be non-negative!</param>
        public Box2D(Vector2 center, Vector2 axis0, Vector2 axis1, Vector2 extents) {
            this.center = center;
            this.axis0 = axis0;
            this.axis1 = axis1;
            this.extents = extents;
        ...
        public Box2D(ref AABB2D box) {
            ...
            this.axis0 = Vector2.Right;
            this.axis1 = Vector2.Up;
        }
        ...
        /// </summary>
        public static Box2D CreateFromPoints(IList<Vector2> points) {
        ...
        public void CalcVertices(out Vector2 vertex0, out Vector2 vertex1, out Vector2 vertex2,
            out Vector2 vertex3) {
            Vector2 vector = this.axis0 * this.extents.x;
            Vector2 vector2 = this.axis1 * this.extents.y;
        ...
        public void Include(ref Box2D box) {
            ...
            for (int i = 0; i < 4; i++) {
                Vector2 vector = array[i] - box2D.center;
                for (int j = 0; j < 2; j++) {

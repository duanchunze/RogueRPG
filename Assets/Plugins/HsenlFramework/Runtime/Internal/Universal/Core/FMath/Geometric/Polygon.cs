...
namespace Hsenl {
    ...
    public class Polygon {
        ...
        /// </summary>
        public Vector3[] vertices => this._vertices;
        ...
        /// </summary>
        public Polygon(Vector3[] vertices, Plane plane) {
        ...
        public void SetVertexProjected(int vertexIndex, Vector3 vertex) {
            ...
            ref Vector3 reference = ref this._vertices[vertexIndex];
        ...
        public void UpdateEdges() {
            ...
            for (int i = 0; i < num; i++) {
                ...
                this._edges[num2].length = Vector3.Normalize(ref vector);
        ...
        public void UpdateEdge(int edgeIndex) {
            Vector3 vector = (this._edges[edgeIndex].point1 = this._vertices[(edgeIndex + 1) % this._vertices.Length]) -
                              (this._edges[edgeIndex].point0 = this._vertices[edgeIndex]);
            this._edges[edgeIndex].length = Vector3.Normalize(ref vector);
        ...
        public Vector3 CalcCenter() {
            Vector3 vector = this._vertices[0];
            int num = this._vertices.Length;
            for (int i = 1; i < num; i++) {
        ...
        public bool HasZeroCorners() {
            ...
            for (int i = 0; i < num; i++) {
                ...
                Vector3.Dot(ref lhs, ref direction, out var num4);
                if (num4 >= num2) {
                    return true;
                }
        ...
        public void ReverseVertices() {
            ...
            for (int i = 0; i < num2; i++) {
                ...
                int num3 = num - i;
                ref Vector3 reference = ref this._vertices[i];

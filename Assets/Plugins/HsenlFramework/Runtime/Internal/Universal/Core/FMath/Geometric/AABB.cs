...
namespace Hsenl {
    ...
    public struct AABB {
        ...
        /// </summary>
        public static AABB CreateFromPoint(ref Vector3 point) {
        ...
        /// Creates AAB from single point. Min and Max are set to point. Use Include() method to grow the resulting AAB.
        /// </summary>
        public static AABB CreateFromPoint(Vector3 point) {
            AABB result = default(AABB);
            result.min = point;
            result.max = point;
            return result;
        ...
        /// </summary>
        public static AABB CreateFromTwoPoints(ref Vector3 point0, ref Vector3 point1) {
            AABB result = default(AABB);
        ...
        /// </summary>
        public static AABB CreateFromTwoPoints(Vector3 point0, Vector3 point1) {
        ...
        /// If a set is empty, returns new AAB3().
        /// </summary>
        public static AABB CreateFromPoints(IList<Vector3> points) {
        ...
        /// If a set is empty, returns new AAB3().
        /// </summary>
        public static AABB CreateFromPoints(Vector3[] points) {
        ...
        public Vector3[] CalcVertices() {
            return new Vector3[8] {
                this.min, new Vector3(this.max.x, this.min.y, this.min.z), new Vector3(this.max.x, this.max.y, this.min.z),
                new Vector3(this.min.x, this.max.y, this.min.z),
                new Vector3(this.min.x, this.min.y, this.max.z), new Vector3(this.max.x, this.min.y, this.max.z), this.max,
        ...
        public void CalcVertices(Vector3[] array) {
            ...
            reference2 = new Vector3(this.max.x, this.min.y, this.min.z);
            ref Vector3 reference3 = ref array[2];
            reference3 = new Vector3(this.max.x, this.max.y, this.min.z);
            ref Vector3 reference4 = ref array[3];
            reference4 = new Vector3(this.min.x, this.max.y, this.min.z);
            ref Vector3 reference5 = ref array[4];
            reference5 = new Vector3(this.min.x, this.min.y, this.max.z);
            ref Vector3 reference6 = ref array[5];
            reference6 = new Vector3(this.max.x, this.min.y, this.max.z);
            ref Vector3 reference7 = ref array[6];
            reference7 = this.max;
            ref Vector3 reference8 = ref array[7];
            reference8 = new Vector3(this.min.x, this.max.y, this.max.z);
        }

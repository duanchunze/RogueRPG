...
namespace Hsenl {
    public static class Distance {
        ...
        public static FLOAT Line2Line2(ref Line2D line0, ref Line2D line1) {
            return Math.Sqrt(SqrLine2Line2(ref line0, ref line1));
        }
        ...
        public static FLOAT Line2Line2(ref Line2D line0, ref Line2D line1, out Vector2 closestPoint0,
            out Vector2 closestPoint1) {
            return Math.Sqrt(SqrLine2Line2(ref line0, ref line1, out closestPoint0, out closestPoint1));
        }
        ...
        /// <param name="closestPoint1">Point on line1 closest to line0</param>
        /// <param name="line0"></param>
        public static FLOAT SqrLine2Line2(ref Line2D line0, ref Line2D line1, out Vector2 closestPoint0,
            out Vector2 closestPoint1) {
            Vector2 vector = line0.origin - line1.origin;
            FLOAT num = 0f - line0.direction.Dot(line1.direction);
            FLOAT num2 = vector.Dot(line0.direction);
        ...
        public static FLOAT Line2Ray2(ref Line2D line, ref Ray2D ray) {
            return Math.Sqrt(SqrLine2Ray2(ref line, ref ray));
        }
        ...
        public static FLOAT Line2Ray2(ref Line2D line, ref Ray2D ray, out Vector2 closestPoint0,
            out Vector2 closestPoint1) {
            return Math.Sqrt(SqrLine2Ray2(ref line, ref ray, out closestPoint0, out closestPoint1));
        }
        ...
        public static FLOAT SqrLine2Ray2(ref Line2D line, ref Ray2D ray) {
            Vector2 vector = line.origin - ray.origin;
        ...
        /// <param name="closestPoint1">Point on ray closest to line</param>
        /// <param name="line"></param>
        public static FLOAT SqrLine2Ray2(ref Line2D line, ref Ray2D ray, out Vector2 closestPoint0,
            out Vector2 closestPoint1) {
            Vector2 vector = line.origin - ray.origin;
            FLOAT num = 0f - line.direction.Dot(ray.direction);
            FLOAT num2 = vector.Dot(line.direction);
        ...
        public static FLOAT Line2Segment2(ref Line2D line, ref Segment2D segment) {
            return Math.Sqrt(SqrLine2Segment2(ref line, ref segment));
        }
        ...
        /// <param name="line"></param>
        public static FLOAT Line2Segment2(ref Line2D line, ref Segment2D segment, out Vector2 closestPoint0,
            out Vector2 closestPoint1) {
            return Math.Sqrt(SqrLine2Segment2(ref line, ref segment, out closestPoint0, out closestPoint1));
        }
        ...
        public static FLOAT SqrLine2Segment2(ref Line2D line, ref Segment2D segment) {
            Vector2 vector = line.origin - segment.center;
        ...
        /// <param name="closestPoint1">Point on segment closest to line</param>
        /// <param name="line"></param>
        public static FLOAT SqrLine2Segment2(ref Line2D line, ref Segment2D segment, out Vector2 closestPoint0,
            out Vector2 closestPoint1) {
            Vector2 vector = line.origin - segment.center;
            FLOAT num = 0f - line.direction.Dot(segment.direction);
            FLOAT num2 = vector.Dot(line.direction);
        ...
        /// </summary>
        public static FLOAT Point2AAB2(ref Vector2 point, ref AABB2D box) {
            FLOAT num = 0f;
            FLOAT x = point.x;
            if (x < box.min.x) {
        ...
        public static FLOAT Point2AAB2(ref Vector2 point, ref AABB2D box, out Vector2 closestPoint) {
            FLOAT num = 0f;
            closestPoint = point;
            FLOAT x = point.x;
            if (x < box.min.x) {
        ...
        /// </summary>
        public static FLOAT SqrPoint2AAB2(ref Vector2 point, ref AABB2D box) {
            FLOAT num = 0f;
            FLOAT x = point.x;
            if (x < box.min.x) {
                FLOAT num2 = box.min.x - x;
        ...
        /// <param name="closestPoint">Point projected on an aab</param>
        /// <param name="point"></param>
        public static FLOAT SqrPoint2AAB2(ref Vector2 point, ref AABB2D box, out Vector2 closestPoint) {
            FLOAT num = 0f;
            closestPoint = point;
            FLOAT x = point.x;
            if (x < box.min.x) {
        ...
        /// </summary>
        public static FLOAT Point2Box2(ref Vector2 point, ref Box2D box) {
            return Math.Sqrt(SqrPoint2Box2(ref point, ref box));
        }
        ...
        /// <param name="point"></param>
        public static FLOAT Point2Box2(ref Vector2 point, ref Box2D box, out Vector2 closestPoint) {
            return Math.Sqrt(SqrPoint2Box2(ref point, ref box, out closestPoint));
        }

        /// <summary>
        /// Returns squared distance between a point and a box
        /// </summary>
        public static FLOAT SqrPoint2Box2(ref Vector2 point, ref Box2D box) {
        ...
        /// <param name="closestPoint">Point projected on a box</param>
        /// <param name="point"></param>
        public static FLOAT SqrPoint2Box2(ref Vector2 point, ref Box2D box, out Vector2 closestPoint) {
            Vector2 vector = point - box.center;
            FLOAT num = 0f;
            FLOAT num2 = vector.Dot(box.axis0);
            FLOAT x = box.extents.x;
        ...
        /// </summary>
        public static FLOAT Point2Circle2(ref Vector2 point, ref Circle2D circle) {
        ...
        /// <param name="point"></param>
        public static FLOAT Point2Circle2(ref Vector2 point, ref Circle2D circle, out Vector2 closestPoint) {
            Vector2 vector = point - circle.center;
            FLOAT sqrMagnitude = vector.sqrMagnitude;
            if (sqrMagnitude > circle.radius * circle.radius) {
                FLOAT num = Math.Sqrt(sqrMagnitude);
        ...
        /// </summary>
        public static FLOAT SqrPoint2Circle2(ref Vector2 point, ref Circle2D circle) {
            FLOAT num = (point - circle.center).magnitude - circle.radius;
            if (!(num > 0f)) {
                return 0f;
            }
        ...
        /// <param name="closestPoint">Point projected on a circle</param>
        /// <param name="point"></param>
        public static FLOAT SqrPoint2Circle2(ref Vector2 point, ref Circle2D circle, out Vector2 closestPoint) {
            Vector2 vector = point - circle.center;
            FLOAT sqrMagnitude = vector.sqrMagnitude;
            if (sqrMagnitude > circle.radius * circle.radius) {
                FLOAT num = Math.Sqrt(sqrMagnitude);
        ...
        /// </summary>
        public static FLOAT Point2Line2(ref Vector2 point, ref Line2D line) {
            return Math.Sqrt(SqrPoint2Line2(ref point, ref line));
        }
        ...
        /// <param name="point"></param>
        public static FLOAT Point2Line2(ref Vector2 point, ref Line2D line, out Vector2 closestPoint) {
            return Math.Sqrt(SqrPoint2Line2(ref point, ref line, out closestPoint));
        }

        /// <summary>
        /// Returns squared distance between a point and a line
        /// </summary>
        public static FLOAT SqrPoint2Line2(ref Vector2 point, ref Line2D line) {
            Vector2 value = point - line.origin;
            FLOAT num = line.direction.Dot(value);
            Vector2 vector = line.origin + num * line.direction;
        ...
        /// <param name="closestPoint">Point projected on a line</param>
        /// <param name="point"></param>
        public static FLOAT SqrPoint2Line2(ref Vector2 point, ref Line2D line, out Vector2 closestPoint) {
            Vector2 value = point - line.origin;
            FLOAT num = line.direction.Dot(value);
        ...
        /// </summary>
        public static FLOAT Point2Ray2(ref Vector2 point, ref Ray2D ray) {
            return Math.Sqrt(SqrPoint2Ray2(ref point, ref ray));
        }
        ...
        /// <param name="point"></param>
        public static FLOAT Point2Ray2(ref Vector2 point, ref Ray2D ray, out Vector2 closestPoint) {
            return Math.Sqrt(SqrPoint2Ray2(ref point, ref ray, out closestPoint));
        }

        /// <summary>
        /// Returns squared distance between a point and a ray
        /// </summary>
        public static FLOAT SqrPoint2Ray2(ref Vector2 point, ref Ray2D ray) {
            Vector2 value = point - ray.origin;
            FLOAT num = ray.direction.Dot(value);
            Vector2 vector = ((!(num > 0f)) ? ray.origin : (ray.origin + num * ray.direction));
            return (vector - point).sqrMagnitude;
        }
        ...
        /// <param name="closestPoint">Point projected on a ray and clamped by ray origin</param>
        /// <param name="point"></param>
        public static FLOAT SqrPoint2Ray2(ref Vector2 point, ref Ray2D ray, out Vector2 closestPoint) {
            Vector2 value = point - ray.origin;
            FLOAT num = ray.direction.Dot(value);
            if (num > 0f) {
        ...
        /// </summary>
        public static FLOAT Point2Segment2(ref Vector2 point, ref Segment2D segment) {
            return Math.Sqrt(SqrPoint2Segment2(ref point, ref segment));
        }
        ...
        /// <param name="point"></param>
        public static FLOAT Point2Segment2(ref Vector2 point, ref Segment2D segment, out Vector2 closestPoint) {
            return Math.Sqrt(SqrPoint2Segment2(ref point, ref segment, out closestPoint));
        }

        /// <summary>
        /// Returns squared distance between a point and a segment
        /// </summary>
        public static FLOAT SqrPoint2Segment2(ref Vector2 point, ref Segment2D segment) {
            Vector2 value = point - segment.center;
            FLOAT num = segment.direction.Dot(value);
            Vector2 vector = ((!(0f - segment.extent < num))
                ? segment.p0
        ...
        /// <param name="closestPoint">Point projected on a segment and clamped by segment endpoints</param>
        /// <param name="point"></param>
        public static FLOAT SqrPoint2Segment2(ref Vector2 point, ref Segment2D segment, out Vector2 closestPoint) {
            Vector2 value = point - segment.center;
            FLOAT num = segment.direction.Dot(value);
        ...
        /// </summary>
        public static FLOAT Point2Triangle2(ref Vector2 point, ref Triangle2D triangle) {
        ...
        /// <param name="point"></param>
        public static FLOAT Point2Triangle2(ref Vector2 point, ref Triangle2D triangle, out Vector2 closestPoint) {
            if (triangle.Contains(point)) {
                closestPoint = point;
                return 0f;
            }
        ...
        /// </summary>
        public static FLOAT SqrPoint2Triangle2(ref Vector2 point, ref Triangle2D triangle) {
            if (triangle.Contains(point)) {
                return 0f;
            }
        ...
        public static FLOAT Ray2Ray2(ref Ray2D ray0, ref Ray2D ray1) {
            return Math.Sqrt(SqrRay2Ray2(ref ray0, ref ray1, out _, out _));
        }
        ...
        public static FLOAT Ray2Ray2(ref Ray2D ray0, ref Ray2D ray1, out Vector2 closestPoint0,
            out Vector2 closestPoint1) {
            return Math.Sqrt(SqrRay2Ray2(ref ray0, ref ray1, out closestPoint0, out closestPoint1));
        }
        ...
        public static FLOAT SqrRay2Ray2(ref Ray2D ray0, ref Ray2D ray1, out Vector2 closestPoint0,
            out Vector2 closestPoint1) {
            Vector2 vector = ray0.origin - ray1.origin;
        ...
        public static FLOAT Ray2Segment2(ref Ray2D ray, ref Segment2D segment) {
            return Math.Sqrt(SqrRay2Segment2(ref ray, ref segment, out _, out _));
        }
        ...
        /// <param name="ray"></param>
        public static FLOAT Ray2Segment2(ref Ray2D ray, ref Segment2D segment, out Vector2 closestPoint0,
            out Vector2 closestPoint1) {
            return Math.Sqrt(SqrRay2Segment2(ref ray, ref segment, out closestPoint0, out closestPoint1));
        }
        ...
        /// <param name="closestPoint1">Point on segment closest to ray</param>
        /// <param name="ray"></param>
        public static FLOAT SqrRay2Segment2(ref Ray2D ray, ref Segment2D segment, out Vector2 closestPoint0,
            out Vector2 closestPoint1) {
            Vector2 vector = ray.origin - segment.center;
            ...
            FLOAT sqrMagnitude = vector.sqrMagnitude;
            FLOAT num4 = Math.Abs(1f - num * num);
            FLOAT num5;
            FLOAT num6;
            FLOAT num9;
            if (num4 >= 1E-05f) {
        ...
        public static FLOAT Segment2Segment2(ref Segment2D segment0, ref Segment2D segment1) {
            return Math.Sqrt(SqrSegment2Segment2(ref segment0, ref segment1, out _, out _));
        }
        ...
        public static FLOAT Segment2Segment2(ref Segment2D segment0, ref Segment2D segment1,
            out Vector2 closestPoint0, out Vector2 closestPoint1) {
            return Math.Sqrt(SqrSegment2Segment2(ref segment0, ref segment1, out closestPoint0, out closestPoint1));
        }
        ...
        private static void Face(ref Box mBox, ref FLOAT mLineParameter, int i0, int i1, int i2, ref Vector3 pnt,
            ref Vector3 dir, ref Vector3 PmE, ref FLOAT sqrDistance) {
        ...
        private static void CaseNoZeros(ref Box mBox, ref FLOAT mLineParameter, ref Vector3 pnt, ref Vector3 dir,
            ref FLOAT sqrDistance) {
            Vector3 PmE = new Vector3(pnt.x - mBox.extents[0], pnt.y - mBox.extents[1], pnt.z - mBox.extents[2]);
        ...
        private static void Case0(ref Box mBox, ref FLOAT mLineParameter, int i0, int i1, int i2, ref Vector3 pnt,
            ref Vector3 dir, ref FLOAT sqrDistance) {
        ...
        private static void Case00(ref Box mBox, ref FLOAT mLineParameter, int i0, int i1, int i2, ref Vector3 pnt,
            ref Vector3 dir, ref FLOAT sqrDistance) {
        ...
        private static void Case000(ref Box mBox, ref FLOAT mLineParameter, ref Vector3 pnt, ref FLOAT sqrDistance) {
        ...
        public static FLOAT Line3Box3(ref Line line, ref Box box, out Line3Box3Dist info) {
            return Math.Sqrt(SqrLine3Box3(ref line, ref box, out info));
        }

        public static FLOAT Line3Box3(ref Line line, ref Box box) {
            return Math.Sqrt(SqrLine3Box3(ref line, ref box, out _));
        }

        public static FLOAT SqrLine3Box3(ref Line line, ref Box box, out Line3Box3Dist info) {
            Vector3 vector = line.origin - box.center;
            Vector3 pnt = new Vector3(vector.Dot(box.axis0), vector.Dot(box.axis1), vector.Dot(box.axis2));
            Vector3 dir = new Vector3(line.direction.Dot(box.axis0), line.direction.Dot(box.axis1),
            ...
            Vector3 closestPoint = line.origin + mLineParameter * line.direction;
        ...
        public static FLOAT Line3Line3(ref Line line0, ref Line line1) {
            return Math.Sqrt(SqrLine3Line3(ref line0, ref line1, out _, out _));
        }
        ...
        /// <param name="closestPoint0">Point on line0 closest to line1</param>
        /// <param name="closestPoint1">Point on line1 closest to line0</param>
        public static FLOAT Line3Line3(ref Line line0, ref Line line1, out Vector3 closestPoint0,
            out Vector3 closestPoint1) {
            return Math.Sqrt(SqrLine3Line3(ref line0, ref line1, out closestPoint0, out closestPoint1));
        }
        ...
        /// <param name="closestPoint1">Point on line1 closest to line0</param>
        /// <param name="line0"></param>
        public static FLOAT SqrLine3Line3(ref Line line0, ref Line line1, out Vector3 closestPoint0,
            out Vector3 closestPoint1) {
        ...
        public static FLOAT Line3Ray3(ref Line line, ref Ray ray) {
            return Math.Sqrt(SqrLine3Ray3(ref line, ref ray, out _, out _));
        }
        ...
        /// <param name="closestPoint0">Point on line closest to ray</param>
        /// <param name="closestPoint1">Point on ray closest to line</param>
        public static FLOAT Line3Ray3(ref Line line, ref Ray ray, out Vector3 closestPoint0,
            out Vector3 closestPoint1) {
            return Math.Sqrt(SqrLine3Ray3(ref line, ref ray, out closestPoint0, out closestPoint1));
        }
        ...
        /// <param name="closestPoint1">Point on ray closest to line</param>
        /// <param name="line"></param>
        public static FLOAT SqrLine3Ray3(ref Line line, ref Ray ray, out Vector3 closestPoint0,
            out Vector3 closestPoint1) {
        ...
        public static FLOAT Line3Segment3(ref Line line, ref Segment segment) {
            ...
            return Math.Sqrt(SqrLine3Segment3(ref line, ref segment, out closestPoint, out closestPoint2));
        }
        ...
        /// <param name="closestPoint0">Point on line closest to segment</param>
        /// <param name="closestPoint1">Point on segment closest to line</param>
        public static FLOAT Line3Segment3(ref Line line, ref Segment segment, out Vector3 closestPoint0,
            out Vector3 closestPoint1) {
            return Math.Sqrt(SqrLine3Segment3(ref line, ref segment, out closestPoint0, out closestPoint1));
        }
        ...
        /// <param name="closestPoint1">Point on segment closest to line</param>
        /// <param name="line"></param>
        public static FLOAT SqrLine3Segment3(ref Line line, ref Segment segment, out Vector3 closestPoint0,
            out Vector3 closestPoint1) {
            Vector3 vector = line.origin - segment.center;
            FLOAT num = 0f - line.direction.Dot(segment.direction);
            FLOAT num2 = vector.Dot(line.direction);
            FLOAT sqrMagnitude = vector.sqrMagnitude;
            FLOAT num3 = Math.Abs(1f - num * num);
        ...
        /// Returns distance between a point and an abb
        /// </summary>
        public static FLOAT Point3AAB3(ref Vector3 point, ref AABB box) {
            FLOAT num = 0f;
            FLOAT x = point.x;
            if (x < box.min.x) {
                FLOAT num2 = box.min.x - x;
        ...
        /// <param name="closestPoint">Point projected on an aab</param>
        /// <param name="point"></param>
        public static FLOAT Point3AAB3(ref Vector3 point, ref AABB box, out Vector3 closestPoint) {
            FLOAT num = 0f;
            closestPoint = point;
            FLOAT x = point.x;
            if (x < box.min.x) {
        ...
        /// Returns squared distance between a point and an abb
        /// </summary>
        public static FLOAT SqrPoint3AAB3(ref Vector3 point, ref AABB box) {
            FLOAT num = 0f;
            FLOAT x = point.x;
            if (x < box.min.x) {
                FLOAT num2 = box.min.x - x;
        ...
        /// <param name="closestPoint">Point projected on an aab</param>
        /// <param name="point"></param>
        public static FLOAT SqrPoint3AAB3(ref Vector3 point, ref AABB box, out Vector3 closestPoint) {
            FLOAT num = 0f;
            closestPoint = point;
            FLOAT x = point.x;
            if (x < box.min.x) {
        ...
        /// Returns distance between a point and a box
        /// </summary>
        public static FLOAT Point3Box3(ref Vector3 point, ref Box box) {
            return Math.Sqrt(SqrPoint3Box3(ref point, ref box));
        }
        ...
        /// <param name="closestPoint">Point projected on a box</param>
        /// <param name="point"></param>
        public static FLOAT Point3Box3(ref Vector3 point, ref Box box, out Vector3 closestPoint) {
            return Math.Sqrt(SqrPoint3Box3(ref point, ref box, out closestPoint));
        }

        /// <summary>
        /// Returns squared distance between a point and a box
        /// </summary>
        public static FLOAT SqrPoint3Box3(ref Vector3 point, ref Box box) {
        ...
        /// <param name="point"></param>
        /// <param name="closestPoint">Point projected on a box</param>
        public static FLOAT SqrPoint3Box3(ref Vector3 point, ref Box box, out Vector3 closestPoint) {
            /*
        ...
        public static FLOAT Point3Circle3(ref Vector3 point, ref Circle circle, bool solid = true) {
            return Math.Sqrt(SqrPoint3Circle3(ref point, ref circle, out var closestPoint, solid));
        }
        ...
        /// <param name="solid">When true circle considered to be solid disk otherwise hollow circle.</param>
        /// <param name="point"></param>
        public static FLOAT Point3Circle3(ref Vector3 point, ref Circle circle, out Vector3 closestPoint,
            bool solid = true) {
            return Math.Sqrt(SqrPoint3Circle3(ref point, ref circle, out closestPoint, solid));
        }
        ...
        /// <param name="solid">When true circle considered to be solid disk otherwise hollow circle.</param>
        /// <param name="point"></param>
        public static FLOAT SqrPoint3Circle3(ref Vector3 point, ref Circle circle, bool solid = true) {
        ...
        /// <param name="solid">When true circle considered to be solid disk otherwise hollow circle.</param>
        /// <param name="point"></param>
        public static FLOAT SqrPoint3Circle3(ref Vector3 point, ref Circle circle, out Vector3 closestPoint,
            bool solid = true) {
            if (solid) {
                ...
                if (sqrMagnitude > circle.radius) {
                    closestPoint = circle.center + circle.radius / Math.Sqrt(sqrMagnitude) * vector2;
            ...
            Vector3 vector4 = vector3 - num2 * circle.normal;
            FLOAT sqrMagnitude2 = vector4.sqrMagnitude;
            if (sqrMagnitude2 >= 1E-05f) {
                closestPoint = circle.center + circle.radius / Math.Sqrt(sqrMagnitude2) * vector4;
                return (point - closestPoint).sqrMagnitude;
            }
        ...
        /// Returns distance between a point and a line
        /// </summary>
        public static FLOAT Point3Line3(ref Vector3 point, ref Line line) {
            return Math.Sqrt(SqrPoint3Line3(ref point, ref line));
        }
        ...
        /// <param name="closestPoint">Point projected on a line</param>
        /// <param name="point"></param>
        public static FLOAT Point3Line3(ref Vector3 point, ref Line line, out Vector3 closestPoint) {
            return Math.Sqrt(SqrPoint3Line3(ref point, ref line, out closestPoint));
        }

        /// <summary>
        /// Returns squared distance between a point and a line
        /// </summary>
        public static FLOAT SqrPoint3Line3(ref Vector3 point, ref Line line) {
            Vector3 value = point - line.origin;
            FLOAT num = line.direction.Dot(value);
            Vector3 vector = line.origin + num * line.direction;
            return (vector - point).sqrMagnitude;
        }
        ...
        /// <param name="closestPoint">Point projected on a line</param>
        /// <param name="point"></param>
        public static FLOAT SqrPoint3Line3(ref Vector3 point, ref Line line, out Vector3 closestPoint) {
            Vector3 value = point - line.origin;
            FLOAT num = line.direction.Dot(value);
            closestPoint = line.origin + num * line.direction;
            return (closestPoint - point).sqrMagnitude;
        ...
        /// </summary>
        public static FLOAT Point3Plane3(ref Vector3 point, ref Plane plane) {
        ...
        /// <param name="point"></param>
        public static FLOAT Point3Plane3(ref Vector3 point, ref Plane plane, out Vector3 closestPoint) {
            FLOAT num = plane.normal.Dot(point) - plane.constant;
            closestPoint = point - num * plane.normal;
            return Math.Abs(num);
        }

        public static FLOAT Point3Plane3(ref Vector3 point, ref Vector3 p0, ref Vector3 p1, ref Vector3 p2, out Vector3 closestPoint) {
            Vector3.Subtract(ref p1, ref p0, out var vector);
            Vector3.Subtract(ref p2, ref p0, out var value);
        ...
        /// </summary>
        public static FLOAT SqrPoint3Plane3(ref Vector3 point, ref Plane plane) {
            FLOAT num = plane.normal.Dot(point) - plane.constant;
            return num * num;
        }
        ...
        /// <param name="closestPoint">Point projected on a plane</param>
        /// <param name="point"></param>
        public static FLOAT SqrPoint3Plane3(ref Vector3 point, ref Plane plane, out Vector3 closestPoint) {
            FLOAT num = plane.normal.Dot(point) - plane.constant;
            closestPoint = point - num * plane.normal;
            return num * num;
        }

        public static FLOAT SqrPoint3Plane3(ref Vector3 point, ref Vector3 p0, ref Vector3 p1, ref Vector3 p2, out Vector3 closestPoint) {
            Vector3.Subtract(ref p1, ref p0, out var vector);
            Vector3.Subtract(ref p2, ref p0, out var value);
            var normal = vector.NormalizeCross(value);
            var constant = normal.Dot(p0);
        ...
        /// Returns distance between a point and a ray
        /// </summary>
        public static FLOAT Point3Ray3(ref Vector3 point, ref Ray ray) {
            return Math.Sqrt(SqrPoint3Ray3(ref point, ref ray));
        }
        ...
        /// <param name="closestPoint">Point projected on a ray and clamped by ray origin</param>
        /// <param name="point"></param>
        public static FLOAT Point3Ray3(ref Vector3 point, ref Ray ray, out Vector3 closestPoint) {
            return Math.Sqrt(SqrPoint3Ray3(ref point, ref ray, out closestPoint));
        }

        /// <summary>
        /// Returns squared distance between a point and a ray
        /// </summary>
        public static FLOAT SqrPoint3Ray3(ref Vector3 point, ref Ray ray) {
            Vector3 value = point - ray.origin;
            FLOAT num = ray.direction.Dot(value);
            Vector3 vector = ((!(num > 0f)) ? ray.origin : (ray.origin + num * ray.direction));
            return (vector - point).sqrMagnitude;
        }
        ...
        /// <param name="closestPoint">Point projected on a ray and clamped by ray origin</param>
        /// <param name="point"></param>
        public static FLOAT SqrPoint3Ray3(ref Vector3 point, ref Ray ray, out Vector3 closestPoint) {
            Vector3 value = point - ray.origin;
            FLOAT num = ray.direction.Dot(value);
            if (num > 0f) {
                closestPoint = ray.origin + num * ray.direction;
        ...
        /// </summary>
        public static FLOAT Point3Rectangle3(ref Vector3 point, ref Rectangle rectangle) {
            return Math.Sqrt(SqrPoint3Rectangle3(ref point, ref rectangle));
        }
        ...
        /// <param name="point"></param>
        public static FLOAT
            Point3Rectangle3(ref Vector3 point, ref Rectangle rectangle, out Vector3 closestPoint) {
            return Math.Sqrt(SqrPoint3Rectangle3(ref point, ref rectangle, out closestPoint));
        }

        /// <summary>
        /// Returns squared distance between a point and a rectangle
        /// </summary>
        public static FLOAT SqrPoint3Rectangle3(ref Vector3 point, ref Rectangle rectangle) {
        ...
        /// Returns distance between a point and a segment
        /// </summary>
        public static FLOAT Point3Segment3(ref Vector3 point, ref Segment segment) {
            return Math.Sqrt(SqrPoint3Segment3(ref point, ref segment));
        }
        ...
        /// <param name="closestPoint">Point projected on a segment and clamped by segment endpoints</param>
        /// <param name="point"></param>
        public static FLOAT Point3Segment3(ref Vector3 point, ref Segment segment, out Vector3 closestPoint) {
            return Math.Sqrt(SqrPoint3Segment3(ref point, ref segment, out closestPoint));
        }

        /// <summary>
        /// Returns squared distance between a point and a segment
        /// </summary>
        public static FLOAT SqrPoint3Segment3(ref Vector3 point, ref Segment segment) {
            Vector3 value = point - segment.center;
            FLOAT num = segment.direction.Dot(value);
            Vector3 vector = ((!(0f - segment.extent < num))
                ? segment.p0
                : ((!(num < segment.extent)) ? segment.p1 : (segment.center + num * segment.direction)));
            return (vector - point).sqrMagnitude;
        }
        ...
        /// <param name="closestPoint">Point projected on a segment and clamped by segment endpoints</param>
        /// <param name="point"></param>
        public static FLOAT SqrPoint3Segment3(ref Vector3 point, ref Segment segment, out Vector3 closestPoint) {
            Vector3 value = point - segment.center;
            FLOAT num = segment.direction.Dot(value);
            if (0f - segment.extent < num) {
                if (num < segment.extent) {
        ...
        public static FLOAT SqrPoint3Segment3(ref Vector3 point, ref Vector3 origin, ref Vector3 end,
            out Vector3 closestPoint) {
            Vector3.Subtract(ref end, ref origin, out var v1);
            Vector3.Subtract(ref point, ref origin, out var v2);

            FLOAT sqrLength = v1.sqrMagnitude;

            if (sqrLength < FLOAT.Epsilon) {
                closestPoint = origin;
                Vector3.DistanceSquared(ref point, ref closestPoint, out var result);
                return result;
            }

            FLOAT projection = Vector3.Dot(v1, v2) / sqrLength;
            if (projection < 0) {
                closestPoint = origin;
                Vector3.DistanceSquared(ref point, ref closestPoint, out var result);
                return result;
                ...
                Vector3.Multiply(ref v1, projection, out var v3);
                Vector3.Add(ref v3, ref origin, out closestPoint);
                Vector3.DistanceSquared(ref point, ref closestPoint, out var result);
                return result;
            }
        }
        ...
        /// </summary>
        public static FLOAT Point3Sphere3(ref Vector3 point, ref Sphere sphere) {
        ...
        /// <param name="point"></param>
        public static FLOAT Point3Sphere3(ref Vector3 point, ref Sphere sphere, out Vector3 closestPoint) {
            Vector3 vector = point - sphere.center;
            FLOAT sqrMagnitude = vector.sqrMagnitude;
        ...
        /// </summary>
        public static FLOAT SqrPoint3Sphere3(ref Vector3 point, ref Sphere sphere) {
            FLOAT num = (point - sphere.center).magnitude - sphere.radius;
            if (!(num > 0f)) {
                return 0f;
            }
        ...
        /// </summary>
        /// <param name="closestPoint">Point projected on a sphere</param>
        public static FLOAT SqrPoint3Sphere3(ref Vector3 point, ref Sphere sphere, out Vector3 closestPoint) {
            Vector3 vector = point - sphere.center;
            FLOAT sqrMagnitude = vector.sqrMagnitude;
            if (sqrMagnitude > sphere.radius * sphere.radius) {
                FLOAT num = Math.Sqrt(sqrMagnitude);
        ...
        public static FLOAT Ray3Ray3(ref Ray ray0, ref Ray ray1) {
            Vector3 closestPoint;
            Vector3 closestPoint2;
            return Math.Sqrt(SqrRay3Ray3(ref ray0, ref ray1, out closestPoint, out closestPoint2));
        }
        ...
        /// <param name="closestPoint0">Point on ray0 closest to ray1</param>
        /// <param name="closestPoint1">Point on ray1 closest to ray0</param>
        public static FLOAT Ray3Ray3(ref Ray ray0, ref Ray ray1, out Vector3 closestPoint0,
            out Vector3 closestPoint1) {
            return Math.Sqrt(SqrRay3Ray3(ref ray0, ref ray1, out closestPoint0, out closestPoint1));
        }
        ...
        /// <param name="closestPoint0">Point on ray0 closest to ray1</param>
        /// <param name="closestPoint1">Point on ray1 closest to ray0</param>
        public static FLOAT SqrRay3Ray3(ref Ray ray0, ref Ray ray1, out Vector3 closestPoint0,
            out Vector3 closestPoint1) {
        ...
        public static FLOAT Ray3Segment3(ref Ray ray, ref Segment segment) {
            Vector3 closestPoint;
            Vector3 closestPoint2;
            return Math.Sqrt(SqrRay3Segment3(ref ray, ref segment, out closestPoint, out closestPoint2));
        }
        ...
        /// <param name="closestPoint0">Point on ray closest to segment</param>
        /// <param name="closestPoint1">Point on segment closest to ray</param>
        public static FLOAT Ray3Segment3(ref Ray ray, ref Segment segment, out Vector3 closestPoint0,
            out Vector3 closestPoint1) {
            return Math.Sqrt(SqrRay3Segment3(ref ray, ref segment, out closestPoint0, out closestPoint1));
        }
        ...
        /// <param name="closestPoint0">Point on ray closest to segment</param>
        /// <param name="closestPoint1">Point on segment closest to ray</param>
        public static FLOAT SqrRay3Segment3(ref Ray ray, ref Segment segment, out Vector3 closestPoint0,
            out Vector3 closestPoint1) {
            Vector3 vector = ray.origin - segment.center;
            FLOAT num = 0f - ray.direction.Dot(segment.direction);
            FLOAT num2 = vector.Dot(ray.direction);
            FLOAT num3 = 0f - vector.Dot(segment.direction);
            FLOAT sqrMagnitude = vector.sqrMagnitude;
        ...
        public static FLOAT Segment3Box3(ref Segment segment, ref Box box, out Vector3 closestPoint0,
            out Vector3 closestPoint1) {
            return Math.Sqrt(SqrSegment3Box3(ref segment, ref box, out closestPoint0, out closestPoint1));
        }

        public static FLOAT Segment3Box3(ref Segment segment, ref Box box) {
            Vector3 closestPoint;
            Vector3 closestPoint2;
            return Math.Sqrt(SqrSegment3Box3(ref segment, ref box, out closestPoint, out closestPoint2));
        }

        public static FLOAT SqrSegment3Box3(ref Segment segment, ref Box box, out Vector3 closestPoint0,
            out Vector3 closestPoint1) {
        ...
        public static FLOAT Segment3Segment3(ref Segment segment0, ref Segment segment1) {
            Vector3 closestPoint;
            Vector3 closestPoint2;
            return Math.Sqrt(SqrSegment3Segment3(ref segment0, ref segment1, out closestPoint, out closestPoint2));
        }
        ...
        /// <param name="closestPoint0">Point on segment0 closest to segment1</param>
        /// <param name="closestPoint1">Point on segment1 closest to segment0</param>
        public static FLOAT Segment3Segment3(ref Segment segment0, ref Segment segment1, out Vector3 closestPoint0,
            out Vector3 closestPoint1) {
            return Math.Sqrt(SqrSegment3Segment3(ref segment0, ref segment1, out closestPoint0, out closestPoint1));
        }
        ...
        /// <param name="closestPoint0">Point on segment0 closest to segment1</param>
        /// <param name="closestPoint1">Point on segment1 closest to segment0</param>
        public static FLOAT SqrSegment3Segment3(ref Segment segment0, ref Segment segment1, out Vector3 closestPoint0,
            out Vector3 closestPoint1) {

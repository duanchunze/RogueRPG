...
namespace FixedMath {
    public static class FMatrix4x4Ex {
        ...
        /// </summary>
        public static void CopyMatrix(ref FMatrix4x4 source, out FMatrix4x4 destination) {
        ...
        /// </summary>
        public static void CreateRotationFromColumns(FVector3 column0, FVector3 column1, FVector3 column2,
            out FMatrix4x4 matrix) {
            matrix = FMatrix4x4.Identity;
        ...
        /// Creates rotation matrix from 3 vectors (vectors are columns of the matrix)
        /// </summary>
        public static void CreateRotationFromColumns(ref FVector3 column0, ref FVector3 column1,
            ref FVector3 column2, out FMatrix4x4 matrix) {
            matrix = FMatrix4x4.Identity;
            matrix.SetColumn(0, column0);
            matrix.SetColumn(1, column1);
            matrix.SetColumn(2, column2);

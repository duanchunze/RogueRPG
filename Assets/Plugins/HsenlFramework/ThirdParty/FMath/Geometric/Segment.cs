...
namespace FixedMath {
    ...
    public struct Segment {
        ...
        public Segment(ref FVector3 p0, ref FVector3 p1) {
            this.p0 = p0;
            this.p1 = p1;
            this.center = (this.direction = FVector3.Zero);
            this.extent = 0f;
        ...
        /// <param name="p0">Segment start point</param>
        /// <param name="p1">Segment end point</param>
        public Segment(FVector3 p0, FVector3 p1) {
            this.p0 = p0;
            this.p1 = p1;
            this.center = (this.direction = FVector3.Zero);
            this.extent = 0f;
        ...
        public Segment(ref FVector3 center, ref FVector3 direction, FLOAT extent) {
            this.center = center;
            this.direction = direction;
            this.extent = extent;
            this.p0 = (this.p1 = FVector3.Zero);
            this.CalcEndPoints();
        }
        ...
        /// <param name="direction">Direction of the segment. Must be unit length!</param>
        /// <param name="extent">Half-length of the segment</param>
        public Segment(FVector3 center, FVector3 direction, FLOAT extent) {
            this.center = center;
            this.direction = direction;
            this.extent = extent;
            this.p0 = (this.p1 = FVector3.Zero);
        ...
        /// </summary>
        public void SetEndpoints(FVector3 p0, FVector3 p1) {
            this.p0 = p0;
            this.p1 = p1;
            this.CalcCenterDirectionExtent();
        }
        ...
        /// </summary>
        public void SetCenterDirectionExtent(FVector3 center, FVector3 direction, FLOAT extent) {
            this.center = center;
            this.direction = direction;
            this.extent = extent;
            this.CalcEndPoints();

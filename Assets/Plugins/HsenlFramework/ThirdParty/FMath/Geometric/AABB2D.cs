...
namespace FixedMath {
    ...
    public struct AABB2D {
        ...
        /// </summary>
        public AABB2D(ref FVector2 min, ref FVector2 max) {
            this.min = min;
            this.max = max;
        }
        ...
        /// Creates AAB from min and max points.
        /// </summary>
        public AABB2D(FVector2 min, FVector2 max) {
            this.min = min;
            this.max = max;
        }
        ...
        /// </summary>
        public static AABB2D CreateFromPoint(ref FVector2 point) {
        ...
        /// Creates AAB from single point. Min and Max are set to point. Use Include() method to grow the resulting AAB.
        /// </summary>
        public static AABB2D CreateFromPoint(FVector2 point) {
            AABB2D result = default(AABB2D);
            result.min = point;
            result.max = point;
            return result;
        ...
        /// </summary>
        public static AABB2D CreateFromTwoPoints(ref FVector2 point0, ref FVector2 point1) {
            AABB2D result = default(AABB2D);
        ...
        /// </summary>
        public static AABB2D CreateFromTwoPoints(FVector2 point0, FVector2 point1) {
        ...
        /// </summary>
        public static AABB2D CreateFromPoints(IEnumerable<FVector2> points) {
        ...
        /// If a set is empty, returns new AAB2().
        /// </summary>
        public static AABB2D CreateFromPoints(IList<FVector2> points) {
        ...
        /// If a set is empty, returns new AAB2()
        /// </summary>
        public static AABB2D CreateFromPoints(FVector2[] points) {
        ...
        /// </summary>
        public void CalcCenterExtents(out FVector2 center, out FVector2 extents) {
        ...
        public void CalcVertices(out FVector2 vertex0, out FVector2 vertex1, out FVector2 vertex2,
            ...
            vertex0 = this.min;
            vertex1 = new FVector2(this.max.x, this.min.y);
            vertex2 = this.max;
            vertex3 = new FVector2(this.min.x, this.max.y);
        }
        ...
        public FVector2[] CalcVertices() {
            return new FVector2[4] { this.min, new FVector2(this.max.x, this.min.y), this.max, new FVector2(this.min.x, this.max.y) };
        }
        ...
        public void CalcVertices(FVector2[] array) {
            ...
            reference2 = new FVector2(this.max.x, this.min.y);
            ref FVector2 reference3 = ref array[2];
            reference3 = this.max;
            ref FVector2 reference4 = ref array[3];
            reference4 = new FVector2(this.min.x, this.max.y);
        }
        ...
        /// </summary>
        public void Include(ref FVector2 point) {
            if (point.x < this.min.x) {
                this.min.x = point.x;
            }
        ...
        /// Enlarges the aab to include the point. If the point is inside the AAB does nothing.
        /// </summary>
        public void Include(FVector2 point) {
            if (point.x < this.min.x) {
                this.min.x = point.x;
            }
            else if (point.x > this.max.x) {

...
namespace FixedMath {
    ...
    public struct Line2D {
        ...
        public Line2D(ref FVector2 origin, ref FVector2 direction) {
            this.origin = origin;
        ...
        /// <param name="origin">Line origin</param>
        /// <param name="direction">Line direction. Must be unit length!</param>
        public Line2D(FVector2 origin, FVector2 direction) {
            this.origin = origin;
            this.direction = direction;
        }
        ...
        public static Line2D CreateFromTwoPoints(ref FVector2 p0, ref FVector2 p1) {
        ...
        /// <param name="p0">First point</param>
        /// <param name="p1">Second point</param>
        public static Line2D CreateFromTwoPoints(FVector2 p0, FVector2 p1) {
            Line2D result = default(Line2D);
            result.origin = p0;
            result.direction = (p1 - p0).normalized;
            return result;
        ...
        /// </summary>
        public static Line2D CreatePerpToLineTrhoughPoint(Line2D line, FVector2 point) {
            Line2D result = default(Line2D);
            result.origin = point;
        ...
        /// </summary>
        public static Line2D CreateBetweenAndEquidistantToPoints(FVector2 point0, FVector2 point1) {
            Line2D result = default(Line2D);
        ...
        public static Line2D CreateParallelToGivenLineAtGivenDistance(Line2D line, FLOAT distance) {
            ...
            result.origin = line.origin + distance * new FVector2(line.direction.y, 0f - line.direction.x);
            return result;
        }
        ...
        /// </summary>
        public FLOAT SignedDistanceTo(FVector2 point) {
        ...
        /// </summary>
        public int QuerySide(FVector2 point) {
        ...
        /// is to the right of the line, 0 if it's on the line, -1 if it's on the left.
        /// </summary>
        public int QuerySide(FVector2 point, FLOAT epsilon) {
            FLOAT num = (point - this.origin).DotPerpendicular(this.direction);
            if (num < 0f - epsilon) {
                return -1;
            }
        ...
        /// </summary>
        public bool QuerySideNegative(FVector2 point) {
            FLOAT epsilon = 1E-05f;
            FLOAT num = (point - this.origin).DotPerpendicular(this.direction);
            return num <= epsilon;
        }
        ...
        /// Returns true if a point is on the negative side of the line, false otherwise.
        /// </summary>
        public bool QuerySideNegative(FVector2 point, FLOAT epsilon) {
            FLOAT num = (point - this.origin).DotPerpendicular(this.direction);
            return num <= epsilon;
        }
        ...
        /// </summary>
        public bool QuerySidePositive(FVector2 point) {
            FLOAT epsilon = 1E-05f;
            FLOAT num = (point - this.origin).DotPerpendicular(this.direction);
        ...
        /// Returns true if a point is on the positive side of the line, false otherwise.
        /// </summary>
        public bool QuerySidePositive(FVector2 point, FLOAT epsilon) {
            FLOAT num = (point - this.origin).DotPerpendicular(this.direction);
            return num >= 0f - epsilon;
        }
        ...
        public int QuerySide(ref Box2D box) {
            ...
            FLOAT num = FMath.Abs(f) + FMath.Abs(f2);

...
namespace FixedMath {
    ...
    public struct Circle2D {
        ...
        /// </summary>
        public Circle2D(ref FVector2 center, FLOAT radius) {
            this.center = center;
            this.radius = radius;
        }
        ...
        /// Creates circle from center and radius
        /// </summary>
        public Circle2D(FVector2 center, FLOAT radius) {
            this.center = center;
            this.radius = radius;
        }
        ...
        /// </summary>
        public static Circle2D CreateFromPointsAAB(IEnumerable<FVector2> points) {
            IEnumerator<FVector2> enumerator = points.GetEnumerator();
            enumerator.Reset();
        ...
        /// If a set is empty returns new Circle2().
        /// </summary>
        public static Circle2D CreateFromPointsAAB(IList<FVector2> points) {
            if (points.Count == 0) {
                return default(Circle2D);
            }
        ...
        /// If a set is empty returns new Circle2().
        /// </summary>
        public static Circle2D CreateFromPointsAverage(IEnumerable<FVector2> points) {
            IEnumerator<FVector2> enumerator = points.GetEnumerator();
            enumerator.Reset();
            if (!enumerator.MoveNext()) {
                return default(Circle2D);
            ...
            FVector2 current = enumerator.Current;
            int num = 1;
        ...
        /// If a set is empty returns new Circle2().
        /// </summary>
        public static Circle2D CreateFromPointsAverage(IList<FVector2> points) {
            int count = points.Count;
            if (count == 0) {
                return default(Circle2D);
            }

            FVector2 vector = points[0];
        ...
        /// </summary>
        public static bool CreateCircumscribed(FVector2 v0, FVector2 v1, FVector2 v2, out Circle2D circle) {
            FVector2 vector = v1 - v0;
            FVector2 vector2 = v2 - v0;
            ...
            if (LinearSystem.Solve2(a, b, out FVector2 X, 1E-05f)) {
                circle.center = v0 + X;
        ...
        /// Returns 'true' if circle has been constructed, 'false' otherwise (input points are linearly dependent).
        /// </summary>
        public static bool CreateInscribed(FVector2 v0, FVector2 v1, FVector2 v2, out Circle2D circle) {
            FVector2 vector = v1 - v0;
            FVector2 value = v2 - v0;
            FVector2 vector2 = v2 - v1;
            ...
            if (num > 1E-05f) {
                ...
                circle.radius = num2 * FMath.Abs(vector.DotPerpendicular(value));
        ...
        public FVector2 Eval(FLOAT t) {
            return new FVector2(this.center.x + this.radius * FMath.Cos(t), this.center.y + this.radius * FMath.Sin(t));
        }
        ...
        public FVector2 Eval(FLOAT t, FLOAT radius) {
            return new FVector2(this.center.x + radius * FMath.Cos(t), this.center.y + radius * FMath.Sin(t));
        }
        ...
        public void Include(ref Circle2D circle) {
            FVector2 vector = circle.center - this.center;

...
namespace FixedMath {
    ...
    public class Polygon2D {
        ...
        /// </summary>
        public FVector2[] vertices => this._vertices;
        ...
        /// </summary>
        public FVector2 this[int vertexIndex] {
        ...
        /// </summary>
        public Polygon2D(FVector2[] vertices) {
            this._vertices = new FVector2[vertices.Length];
        ...
        public Polygon2D(int vertexCount) {
            this._vertices = new FVector2[vertexCount];
            ...
            switch (projectionPlane) {
                case ProjectionPlanes.XY: {
                    ...
                    for (int vertexCount2 = polygon.vertexCount; j < vertexCount2; j++) {
                        ref FVector2 reference2 = ref polygon2D._vertices[j];
                ...
                case ProjectionPlanes.XZ: {
                    ...
                    for (int vertexCount3 = polygon.vertexCount; k < vertexCount3; k++) {
                        ref FVector2 reference3 = ref polygon2D._vertices[k];
                ...
                default: {
                    ...
                    for (int vertexCount = polygon.vertexCount; i < vertexCount; i++) {
                        ref FVector2 reference = ref polygon2D._vertices[i];
        ...
        public void UpdateEdges() {
            ...
            int num2 = num - 1;
            for (int i = 0; i < num; i++) {
                FVector2 vector = (this._edges[num2].point1 = this._vertices[i]) - (this._edges[num2].point0 = this._vertices[num2]);
                this._edges[num2].length = FVector2.Normalize(ref vector);
        ...
        public void UpdateEdge(int edgeIndex) {
            FVector2 vector = (this._edges[edgeIndex].point1 = this._vertices[(edgeIndex + 1) % this._vertices.Length]) -
                              (this._edges[edgeIndex].point0 = this._vertices[edgeIndex]);
            this._edges[edgeIndex].length = FVector2.Normalize(ref vector);
        ...
        /// </summary>
        public FVector2 CalcCenter() {
            FVector2 vector = this._vertices[0];
            int num = this._vertices.Length;
            for (int i = 1; i < num; i++) {
        ...
        public bool IsConvex(out Orientations orientation) {
            ...
            int num3 = num - 1;
            for (int i = 0; i < num; i++) {
                FVector2 vector = -this._edges[num3].direction;
                FVector2 direction = this._edges[i].direction;
        ...
        public bool HasZeroCorners() {
            ...
            int num3 = num - 1;
            for (int i = 0; i < num; i++) {
                FVector2 lhs = -this._edges[num3].direction;
                FVector2 direction = this._edges[i].direction;
                FVector2.Dot(ref lhs, ref direction, out var num4);
                if (num4 >= num2) {
                    return true;
                }
        ...
        public void ReverseVertices() {
            ...
            for (int i = 0; i < num2; i++) {
                FVector2 vector = this._vertices[i];
                int num3 = num - i;
                ref FVector2 reference = ref this._vertices[i];
        ...
        /// </summary>
        public bool ContainsConvexQuadCCW(ref FVector2 point) {
        ...
        /// Tests whether a point is contained by the convex CCW 4-sided polygon (the caller must ensure that polygon is indeed CCW ordered)
        /// </summary>
        public bool ContainsConvexQuadCCW(FVector2 point) {
        ...
        /// </summary>
        public bool ContainsConvexQuadCW(ref FVector2 point) {
            if (this._vertices.Length != 4) {
                return false;
            }
        ...
        /// Tests whether a point is contained by the convex CW 4-sided polygon (the caller must ensure that polygon is indeed CW ordered)
        /// </summary>
        public bool ContainsConvexQuadCW(FVector2 point) {
        ...
        /// </summary>
        public bool ContainsConvexCCW(ref FVector2 point) {
        ...
        /// Tests whether a point is contained by the convex CCW polygon (the caller must ensure that polygon is indeed CCW ordered)
        /// </summary>
        public bool ContainsConvexCCW(FVector2 point) {
            return this.ContainsConvexCCW(ref point);
        }

        private bool SubContainsPointCCW(ref FVector2 p, int i0, int i1) {
            int num = this._vertices.Length;
            int num2 = i1 - i0;
            FLOAT num3;
            FLOAT num4;
        ...
        /// </summary>
        public bool ContainsConvexCW(ref FVector2 point) {
        ...
        /// Tests whether a point is contained by the convex CW polygon (the caller must ensure that polygon is indeed CW ordered)
        /// </summary>
        public bool ContainsConvexCW(FVector2 point) {
            return this.ContainsConvexCW(ref point);
        }

        private bool SubContainsPointCW(ref FVector2 p, int i0, int i1) {
            int num = this._vertices.Length;
            int num2 = i1 - i0;
            FLOAT num3;
            FLOAT num4;
        ...
        /// </summary>
        public bool ContainsSimple(ref FVector2 point) {
            bool flag = false;
            int num = this._vertices.Length;
            int i = 0;
            int num2 = num - 1;
            for (; i < num; i++) {
                FVector2 vector = this._vertices[i];
                FVector2 vector2 = this._vertices[num2];
        ...
        /// Note that points which are on border may be classified differently depending on the point position.
        /// </summary>
        public bool ContainsSimple(FVector2 point) {

...
namespace FixedMath {
    internal class Query2 : Query {
        ...
        public Query2(FVector2[] vertices) {
        ...
        public int ToLine(ref FVector2 test, int v0, int v1) {
            bool flag = Sort(ref v0, ref v1);
            FVector2 vector = this._vertices[v0];
            FVector2 vector2 = this._vertices[v1];
        ...
        public int ToTriangle(ref FVector2 test, int v0, int v1, int v2) {
        ...
        public int ToCircumcircle(ref FVector2 test, int v0, int v1, int v2) {
            bool flag = Sort(ref v0, ref v1, ref v2);
            FVector2 vector = this._vertices[v0];
            FVector2 vector2 = this._vertices[v1];
            FVector2 vector3 = this._vertices[v2];

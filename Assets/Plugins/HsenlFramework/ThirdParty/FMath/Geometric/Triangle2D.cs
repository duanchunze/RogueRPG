...
namespace FixedMath {
    public struct Triangle2D {
        ...
        /// </summary>
        public Triangle2D(ref FVector2 v0, ref FVector2 v1, ref FVector2 v2) {
            this.v0 = v0;
            this.v1 = v1;
            this.v2 = v2;
        }
        ...
        /// Creates Triangle2 from 3 vertices
        /// </summary>
        public Triangle2D(FVector2 v0, FVector2 v1, FVector2 v2) {
            this.v0 = v0;
            this.v1 = v1;
            this.v2 = v2;
        }
        ...
        /// Edge[i] = V[i+1]-V[i]
        /// </summary>
        public FVector2 CalcEdge(int edgeIndex) {
        ...
        public FLOAT CalcArea() {
            return 0.5f * FMath.Abs(this.CalcDeterminant());
        }

        /// <summary>
        /// Calculates area of the triangle defined by 3 points.
        /// </summary>
        public static FLOAT CalcArea(ref FVector2 v0, ref FVector2 v1, ref FVector2 v2) {
            return 0.5f *
                   FMath.Abs(v1.x * v2.y + v0.x * v1.y + v2.x * v0.y - v1.x * v0.y - v2.x * v1.y - v0.x * v2.y);
        }

        /// <summary>
        /// Calculates area of the triangle defined by 3 points.
        /// </summary>
        public static FLOAT CalcArea(FVector2 v0, FVector2 v1, FVector2 v2) {
            return 0.5f *
                   FMath.Abs(v1.x * v2.y + v0.x * v1.y + v2.x * v0.y - v1.x * v0.y - v2.x * v1.y - v0.x * v2.y);
        }
        ...
        public FVector3 CalcAnglesDeg() {
            ...
            FLOAT num6 = 2f * FMath.Sqrt(num5);
            FVector3 result = default(FVector3);
            result.x = FMath.Acos((num4 + num5 - num3) / (FMath.Sqrt(num4) * num6)) * 57.29578f;
            result.y = FMath.Acos((num3 + num5 - num4) / (FMath.Sqrt(num3) * num6)) * 57.29578f;
        ...
        /// Angles are returned in the instance of FVector3 following way: (angle of vertex V0, angle of vertex V1, angle of vertex V2)
        /// </summary>
        public static FVector3 CalcAnglesDeg(ref FVector2 v0, ref FVector2 v1, ref FVector2 v2) {
            FLOAT num = v2.x - v1.x;
        ...
        /// Angles are returned in the instance of FVector3 following way: (angle of vertex V0, angle of vertex V1, angle of vertex V2)
        /// </summary>
        public static FVector3 CalcAnglesDeg(FVector2 v0, FVector2 v1, FVector2 v2) {
        ...
        public FVector3 CalcAnglesRad() {
            ...
            FLOAT num6 = 2f * FMath.Sqrt(num5);
            FVector3 result = default(FVector3);
            result.x = FMath.Acos((num4 + num5 - num3) / (FMath.Sqrt(num4) * num6));
            result.y = FMath.Acos((num3 + num5 - num4) / (FMath.Sqrt(num3) * num6));
        ...
        /// Angles are returned in the instance of FVector3 following way: (angle of vertex V0, angle of vertex V1, angle of vertex V2)
        /// </summary>
        public static FVector3 CalcAnglesRad(ref FVector2 v0, ref FVector2 v1, ref FVector2 v2) {
            FLOAT num = v2.x - v1.x;
            FLOAT num2 = v2.y - v1.y;
            FLOAT num3 = num * num + num2 * num2;
            num = v2.x - v0.x;
        ...
        /// Angles are returned in the instance of FVector3 following way: (angle of vertex V0, angle of vertex V1, angle of vertex V2)
        /// </summary>
        public static FVector3 CalcAnglesRad(FVector2 v0, FVector2 v1, FVector2 v2) {
        ...
        /// </summary>
        public FVector2 EvalBarycentric(FLOAT c0, FLOAT c1) {
            FLOAT num = 1f - c0 - c1;
        ...
        /// </summary>
        public FVector2 EvalBarycentric(ref FVector3 baryCoords) {
        ...
        /// The result is c0*V0 + c1*V1 + c2*V2, 0 &lt;= c0,c1,c2 &lt;= 1, c0+c1+c2=1
        /// </summary>
        public FVector2 EvalBarycentric(FVector3 baryCoords) {
            return baryCoords.x * this.v0 + baryCoords.y * this.v1 + baryCoords.z * this.v2;
        }
        ...
        /// </summary>
        public static void CalcBarycentricCoords(ref FVector2 point, ref FVector2 v0, ref FVector2 v1,
            ref FVector2 v2, out FVector3 baryCoords) {
            FVector2 vector = v1 - v0;
            FVector2 value = v2 - v0;
            FVector2 vector2 = point - v0;
            FVector2.Dot(ref vector, ref vector, out var num);
            FVector2.Dot(ref vector, ref value, out var num2);
            FVector2.Dot(ref value, ref value, out var num3);
            FVector2.Dot(ref vector2, ref vector, out var num4);
            FVector2.Dot(ref vector2, ref value, out var num5);
        ...
        /// </summary>
        public FVector3 CalcBarycentricCoords(ref FVector2 point) {
        ...
        /// Calculate barycentric coordinates for the input point regarding to the triangle.
        /// </summary>
        public FVector3 CalcBarycentricCoords(FVector2 point) {
            CalcBarycentricCoords(ref point, ref this.v0, ref this.v1, ref this.v2, out var baryCoords);
            return baryCoords;
        }
        ...
        /// </summary>
        public int QuerySideCCW(FVector2 point) {
        ...
        /// Method must be called for CCW ordered triangles.
        /// </summary>
        public int QuerySideCCW(FVector2 point, FLOAT epsilon) {
            FLOAT num = (point.x - this.v0.x) * (this.v1.y - this.v0.y) - (point.y - this.v0.y) * (this.v1.x - this.v0.x);
            if (num > epsilon) {
                return 1;
            }
        ...
        /// </summary>
        public int QuerySideCW(FVector2 point) {
            FLOAT epsilon = 1E-05f;
        ...
        /// Method must be called for CW ordered triangles.
        /// </summary>
        public int QuerySideCW(FVector2 point, FLOAT epsilon) {
            FLOAT num = 0f - epsilon;
            FLOAT num2 = (point.x - this.v0.x) * (this.v1.y - this.v0.y) - (point.y - this.v0.y) * (this.v1.x - this.v0.x);
            if (num2 < num) {
                return 1;
        ...
        /// </summary>
        public bool ContainsCCW(ref FVector2 point) {
        ...
        /// Tests whether a point is contained by the CCW triangle
        /// </summary>
        public bool ContainsCCW(FVector2 point) {
        ...
        /// </summary>
        public bool ContainsCW(ref FVector2 point) {
            if ((point.x - this.v0.x) * (this.v1.y - this.v0.y) - (point.y - this.v0.y) * (this.v1.x - this.v0.x) < 0f) {
                return false;
            }
        ...
        /// Tests whether a point is contained by the CW triangle
        /// </summary>
        public bool ContainsCW(FVector2 point) {

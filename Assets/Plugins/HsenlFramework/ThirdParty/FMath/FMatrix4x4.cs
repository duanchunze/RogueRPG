...
namespace FixedMath {
    ...
    public struct FMatrix4x4 : IEquatable<FMatrix4x4> {
        internal static FMatrix4x4 InternalIdentity;
        public static readonly FMatrix4x4 Identity;
        public static readonly FMatrix4x4 Zero;

        static FMatrix4x4() {
            Zero = new FMatrix4x4();
            Identity = new FMatrix4x4 { m11 = 1, m22 = 1, m33 = 1, m44 = 1 };
        ...
        public FVector3 position {
            get => new FVector3(this.m14, this.m24, this.m34);
            /* 不应该直接修改矩阵的 position
            set
            {
                m14 = value.x;
        ...
        public FQuaternion rotation {
            get {
                var v1 = new FVector3(this.m13, this.m23, this.m33); // 获得第三列，第三列代表的是坐标系的正方向
                var v2 = new FVector3(this.m12, this.m22, this.m32); // 获得第二列，代表的是坐标轴的正上方
                FQuaternion.CreateLookRotation(ref v1, ref v2, out var result);
                return result;
            }
        }
        ...
        public FVector3 scale {
            get {
                var x = FMath.Sqrt(this.m11 * this.m11 + this.m21 * this.m21 + this.m31 * this.m31);
                var y = FMath.Sqrt(this.m12 * this.m12 + this.m22 * this.m22 + this.m32 * this.m32);
                var z = FMath.Sqrt(this.m13 * this.m13 + this.m23 * this.m23 + this.m33 * this.m33);
                x *= FMath.Sign(this.m11);
                y *= FMath.Sign(this.m12);
                z *= FMath.Sign(this.m13);
        ...
        /// 矩阵的转置矩阵
        /// </summary>
        public FMatrix4x4 transposition {
            get {
        ...
        public FMatrix4x4(FLOAT m11, FLOAT m12, FLOAT m13, FLOAT m14, FLOAT m21, FLOAT m22, FLOAT m23, FLOAT m24, FLOAT m31,
        ...
        private static FMatrix4x4 CreateTranslation(FVector3 position) {
            FMatrix4x4 result;
        ...
        /// <returns>返回一个矩阵</returns>
        private static FMatrix4x4 CreateTranslation(FLOAT xPosition, FLOAT yPosition, FLOAT zPosition) {
            FMatrix4x4 result;
        ...
        /// <param name="result">返回一个矩阵</param>
        private static void CreateTranslation(ref FVector3 position, out FMatrix4x4 result) {
            result.m11 = 1;
            result.m12 = 0;
            result.m13 = 0;
            result.m14 = position.x;
        ...
        /// <returns>返回一个矩阵</returns>
        public static FMatrix4x4 CreateRotation(FVector3 euler) {
        ...
        /// <returns></returns>
        private static FMatrix4x4 CreateRotationOfEuler(FVector3 euler) {
             ...
             * return new Vector3(FMath.RadToDeg(p), FMath.RadToDeg(h), FMath.RadToDeg(b));
             *
             * 
             * 左手坐标系下的基础旋转矩阵
             * 
            ...
            var p = FMath.DegToRad(euler.x);
            var h = FMath.DegToRad(euler.y);
            var b = FMath.DegToRad(euler.z);
            var cosp = FMath.Cos(p);
            var cosh = FMath.Cos(h);
            var cosb = FMath.Cos(b);
            var sinp = FMath.Sin(p);
            var sinh = FMath.Sin(h);
            var sinb = FMath.Sin(b);
        ...
        /// <returns>返回一个矩阵</returns>
        public static FMatrix4x4 CreateRotation(FLOAT xEuler, FLOAT yEuler, FLOAT zEuler) {
        ...
        /// <param name="euler">旋转欧拉角</param>
        /// <param name="result">返回一个矩阵</param>
        public static void CreateRotation(ref FVector3 euler, out FMatrix4x4 result) {
            FQuaternion.Euler(ref euler, out var q);
        ...
        /// <returns>返回一个矩阵</returns>
        public static FMatrix4x4 CreateRotation(FQuaternion quaternion) {
        ...
        /// <param name="quaternion">旋转四元数</param>
        /// <param name="result">返回一个矩阵</param>
        public static void CreateRotation(ref FQuaternion quaternion, out FMatrix4x4 result) {
        ...
        /// <returns>返回一个矩阵</returns>
        private static FMatrix4x4 CreateScale(FVector3 scales) {
        ...
        /// <returns>返回一个矩阵</returns>
        private static FMatrix4x4 CreateScale(FLOAT xScale, FLOAT yScale, FLOAT zScale) {
            FMatrix4x4 result;
        ...
        /// <param name="zScale"></param>
        /// <param name="result">返回一个矩阵</param>
        private static void CreateScale(FLOAT xScale, FLOAT yScale, FLOAT zScale, out FMatrix4x4 result) {
            result.m11 = xScale;
            result.m12 = 0;
            result.m13 = 0;
            result.m14 = 0;
        ...
        /// <param name="scales">缩放</param>
        /// <param name="result">返回一个矩阵</param>
        private static void CreateScale(ref FVector3 scales, out FMatrix4x4 result) {
        ...
        /// <returns>返回一个矩阵</returns>
        private static FMatrix4x4 CreateScale(FVector3 scales, FVector3 centerPoint) {
        ...
        /// <param name="centerPoint">中心点</param>
        /// <returns>返回一个矩阵</returns>
        private static FMatrix4x4 CreateScale(FLOAT xScale, FLOAT yScale, FLOAT zScale, FVector3 centerPoint) {
            FMatrix4x4 result;
        ...
        /// <param name="centerPoint">中心点</param>
        /// <param name="result">返回一个矩阵</param>
        private static void CreateScale(FLOAT xScale, FLOAT yScale, FLOAT zScale, ref FVector3 centerPoint,
            out FMatrix4x4 result) {
            var tx = centerPoint.x * (1 - xScale);
            var ty = centerPoint.y * (1 - yScale);
            var tz = centerPoint.z * (1 - zScale);
        ...
        /// <param name="centerPoint">中心点</param>
        /// <param name="result">返回一个矩阵</param>
        private static void CreateScale(ref FVector3 scales, ref FVector3 centerPoint, out FMatrix4x4 result) {
        ...
        /// <returns>返回一个矩阵</returns>
        private static FMatrix4x4 CreateRotateX(FLOAT angle) {
            FMatrix4x4 result;
        ...
        /// <param name="centerPoint">中心点</param>
        /// <returns>返回一个矩阵</returns>
        private static FMatrix4x4 CreateRotateX(FLOAT angle, FVector3 centerPoint) {
            FMatrix4x4 result;
        ...
        /// <param name="angle">角度</param>
        /// <returns>返回一个矩阵</returns>
        private static FMatrix4x4 CreateRotateY(FLOAT angle) {
            FMatrix4x4 result;
        ...
        /// <param name="centerPoint">中心点</param>
        /// <returns>返回一个矩阵</returns>
        private static FMatrix4x4 CreateRotateY(FLOAT angle, FVector3 centerPoint) {
            FMatrix4x4 result;
        ...
        /// <param name="angle">角度</param>
        /// <returns>返回一个矩阵</returns>
        private static FMatrix4x4 CreateRotateZ(FLOAT angle) {
            FMatrix4x4 result;
        ...
        /// <param name="centerPoint">中心点</param>
        /// <returns>返回一个矩阵</returns>
        private static FMatrix4x4 CreateRotateZ(FLOAT angle, FVector3 centerPoint) {
            FMatrix4x4 result;
        ...
        /// <param name="angle">角度</param>
        /// <returns>返回一个矩阵</returns>
        public static FMatrix4x4 CreateAngleAxis(FVector3 axis, FLOAT angle) {
        ...
        /// <param name="angle">角度</param>
        /// <param name="result">返回一个矩阵</param>
        public static void CreateAngleAxis(ref FVector3 axis, FLOAT angle, out FMatrix4x4 result) {
        ...
        /// <returns>返回一个矩阵</returns>
        public static FMatrix4x4 CreateLookAt(FVector3 from, FVector3 to, FVector3 up) {
        ...
        public static void CreateLookAt(ref FVector3 from, ref FVector3 to, ref FVector3 up,
            ...
            FVector3.Cross(ref up, ref w, out var u);
            u.Normalize();
            FVector3.Cross(ref w, ref u, out var v);
        ...
        private static void CreateShadowDirectional(ref Plane shadowPlane, ref FVector3 dirLightOppositeDirection, out FMatrix4x4 result) {
            FVector3 normal = shadowPlane.normal;
        ...
        /// <param name="result"></param>
        private static void CreateShadowPoint(ref Plane shadowPlane, ref FVector3 pointLightPosition, out FMatrix4x4 result) {
            FVector3 normal = shadowPlane.normal;
            FLOAT constant = shadowPlane.constant;
        ...
        /// <param name="result"></param>
        private static void CreateShadow(ref Plane shadowPlane, ref FVector4 lightData, out FMatrix4x4 result) {
            FVector3 normal = shadowPlane.normal;
            FLOAT constant = shadowPlane.constant;
        ...
        /// <returns>返回一个矩阵</returns>
        public static FMatrix4x4 CreateTRS(FVector3 position, FQuaternion rotation, FVector3 scale) {
        ...
        public static void CreateTRS(ref FVector3 position, ref FQuaternion rotation, ref FVector3 scale,
            out FMatrix4x4 matrix) {
        ...
        /// </summary>
        private static void CreateTRS(ref FVector3 position, ref FVector3 rotationOrigin, ref FQuaternion rotation, ref FVector3 scale,
            out FMatrix4x4 result) {
        ...
        /// </summary>
        public static void CreateTR(ref FVector3 position, ref FQuaternion rotation, out FMatrix4x4 result) {
            CreateRotation(ref rotation, out result);
            result.m14 = position.x;
            result.m24 = position.y;
            result.m34 = position.z;
        ...
        /// </summary>
        private static void CreateTR(ref FVector3 position, ref FVector3 rotationOrigin, ref FQuaternion rotation,
            out FMatrix4x4 result) {
            CreateRotation(ref rotation, out result);
            result.m14 = 0f -
        ...
        /// </summary>
        public static void CreateTS(ref FVector3 position, ref FVector3 scale, out FMatrix4x4 result) {
            result.m11 = scale.x;
            result.m22 = scale.y;
            result.m33 = scale.z;
            result.m14 = position.x;
        ...
        /// <returns></returns>
        private static FMatrix4x4 CreateOrthographic(float width, float height, float zNearPlane, float zFarPlane) {
            FMatrix4x4 matrix44;
        ...
        /// <returns></returns>
        public static FMatrix4x4 Abs(FMatrix4x4 matrix) {
        ...
        /// <param name="matrix"></param>
        /// <param name="result"></param>
        public static void Abs(ref FMatrix4x4 matrix, out FMatrix4x4 result) {
            var m11 = FMath.Abs(matrix.m11);
            var m12 = FMath.Abs(matrix.m12);
            var m13 = FMath.Abs(matrix.m13);
            var m14 = FMath.Abs(matrix.m14);
            var m21 = FMath.Abs(matrix.m21);
            var m22 = FMath.Abs(matrix.m22);
            var m23 = FMath.Abs(matrix.m23);
            var m24 = FMath.Abs(matrix.m24);
            var m31 = FMath.Abs(matrix.m31);
            var m32 = FMath.Abs(matrix.m32);
            var m33 = FMath.Abs(matrix.m33);
            var m34 = FMath.Abs(matrix.m34);
            var m41 = FMath.Abs(matrix.m31);
            var m42 = FMath.Abs(matrix.m32);
            var m43 = FMath.Abs(matrix.m33);
            var m44 = FMath.Abs(matrix.m34);
        ...
        /// <param name="matrix"></param>
        /// <returns></returns>
        public static FMatrix4x4 Invert(FMatrix4x4 matrix) {
        ...
        /// <param name="matrix"></param>
        /// <param name="result"></param>
        public static void Invert(ref FMatrix4x4 matrix, out FMatrix4x4 result) {
            //                                       -1
        ...
        /// <param name="matrix"></param>
        /// <param name="result"></param>
        public static void Transpose(ref FMatrix4x4 matrix, out FMatrix4x4 result) {
            var m11 = matrix.m11;
            var m12 = matrix.m21;
            var m13 = matrix.m31;
            var m14 = matrix.m41;
        ...
        /// <returns></returns>
        public static FMatrix4x4 Lerp(FMatrix4x4 matrix1, FMatrix4x4 matrix2, FLOAT amount) {
        ...
        /// <param name="result"></param>
        /// <returns></returns>
        public static void Lerp(ref FMatrix4x4 matrix1, ref FMatrix4x4 matrix2, FLOAT amount,
            out FMatrix4x4 result) {
        ...
        /// <returns></returns>
        public static FVector3 TransformPoint(FMatrix4x4 value1, FVector3 point) {
        ...
        /// <param name="point"></param>
        /// <param name="result"></param>
        public static void TransformPoint(ref FMatrix4x4 value1, ref FVector3 point, out FVector3 result) {
        ...
        /// <param name="point"></param>
        /// <returns></returns>
        public static FVector3 TransformPointFast(FMatrix4x4 value1, FVector3 point) {
            FVector3 result;
            result.x = value1.m11 * point.x + value1.m12 * point.y + value1.m13 * point.z + value1.m14;
            result.y = value1.m21 * point.x + value1.m22 * point.y + value1.m23 * point.z + value1.m24;
            result.z = value1.m31 * point.x + value1.m32 * point.y + value1.m33 * point.z + value1.m34;
        ...
        /// <param name="point"></param>
        /// <param name="result"></param>
        public static void TransformPointFast(ref FMatrix4x4 value1, ref FVector3 point, out FVector3 result) {
            result.x = value1.m11 * point.x + value1.m12 * point.y + value1.m13 * point.z + value1.m14;
            result.y = value1.m21 * point.x + value1.m22 * point.y + value1.m23 * point.z + value1.m24;
            result.z = value1.m31 * point.x + value1.m32 * point.y + value1.m33 * point.z + value1.m34;
        }
        ...
        /// <returns></returns>
        public static FVector3 TransformDirection(FMatrix4x4 value1, FVector3 vector) {
        ...
        /// <param name="result"></param>
        /// <returns></returns>
        public static void TransformDirection(ref FMatrix4x4 value1, ref FVector3 vector, out FVector3 result) {
        ...
        /// <param name="vector"></param>
        /// <returns></returns>
        public static FVector3 TransposedTransformDirection(FMatrix4x4 value1, FVector3 vector) {
        ...
        /// <param name="result"></param>
        /// <returns></returns>
        public static void TransposedTransformDirection(ref FMatrix4x4 value1, ref FVector3 vector,
            out FVector3 result) {
        ...
        public void SetRow(int index, FVector4 value) {
        ...
        /// <param name="index"></param>
        /// <param name="value"></param>
        public void SetColumn(int index, FVector4 value) {
        ...
        public void SetTRS(FVector3 pos, FQuaternion rot, FVector3 scl) {
        ...
        */
        ...
        /// </summary>
        /// <returns></returns>
        internal FMatrix3x3 ToFMatrix3x3() {
            FMatrix3x3 result = default;
        ...
        public bool Equals(FMatrix4x4 other) {
            return FMath.CompareApproximate(this.m11, other.m11) &&
                   ...
                   FMath.CompareApproximate(this.m14, other.m14) &&
                   ...
                   FMath.CompareApproximate(this.m24, other.m24) &&
                   ...
                   FMath.CompareApproximate(this.m34, other.m44) &&
                   FMath.CompareApproximate(this.m41, other.m41) &&
                   FMath.CompareApproximate(this.m42, other.m42) &&
                   FMath.CompareApproximate(this.m43, other.m43) &&
                   FMath.CompareApproximate(this.m44, other.m44);
        }

        public override bool Equals(object obj) {
            if (!(obj is FMatrix4x4 other)) return false;
        ...
        public static void Add(ref FMatrix4x4 value1, ref FMatrix4x4 value2, out FMatrix4x4 result) {
        ...
        public static void Subtract(ref FMatrix4x4 value1, ref FMatrix4x4 value2, out FMatrix4x4 result) {
            var m11 = value1.m11 - value2.m11;
            var m12 = value1.m12 - value2.m12;
            var m13 = value1.m13 - value2.m13;
            var m14 = value1.m14 - value2.m14;
        ...
        public static void Multiply(ref FMatrix4x4 value1, ref FMatrix4x4 value2, out FMatrix4x4 result) {
        ...
        public static void Multiply(ref FMatrix4x4 value1, ref FVector4 value2, out FVector4 result) {
        ...
        public static void Multiply(ref FMatrix4x4 value1, FLOAT value2, out FMatrix4x4 result) {
        ...
        public static void Negate(ref FMatrix4x4 value, out FMatrix4x4 result) {
            var m11 = -value.m11;
            var m12 = -value.m12;
            var m13 = -value.m13;
            var m14 = -value.m14;
        ...
        public static bool operator ==(FMatrix4x4 v1, FMatrix4x4 v2) {
            return FMath.CompareApproximate(v1.m11, v2.m11) &&
                   ...
                   FMath.CompareApproximate(v1.m14, v2.m14) &&
                   FMath.CompareApproximate(v1.m21, v2.m21) &&
                   FMath.CompareApproximate(v1.m22, v2.m22) &&
                   FMath.CompareApproximate(v1.m23, v2.m23) &&
                   FMath.CompareApproximate(v1.m24, v2.m24) &&
                   FMath.CompareApproximate(v1.m31, v2.m31) &&
                   FMath.CompareApproximate(v1.m32, v2.m32) &&
                   FMath.CompareApproximate(v1.m33, v2.m33) &&
                   FMath.CompareApproximate(v1.m34, v2.m44) &&
                   FMath.CompareApproximate(v1.m41, v2.m41) &&
                   FMath.CompareApproximate(v1.m42, v2.m42) &&
                   FMath.CompareApproximate(v1.m43, v2.m43) &&
                   FMath.CompareApproximate(v1.m44, v2.m44);
        }
        ...
        public static FMatrix4x4 operator +(FMatrix4x4 v1, FMatrix4x4 v2) {
            Add(ref v1, ref v2, out var result);
            return result;
        }

        public static FMatrix4x4 operator -(FMatrix4x4 v) {
        ...
        public static FMatrix4x4 operator *(FMatrix4x4 v1, FLOAT v2) {
            Multiply(ref v1, v2, out var result);
            return result;
        }

        public static FMatrix4x4 operator *(FLOAT v2, FMatrix4x4 v1) {
            Multiply(ref v1, v2, out var result);
            return result;
        }
        ...
        public static FVector4 operator *(FMatrix4x4 v1, FVector4 v2) {
            Multiply(ref v1, ref v2, out var result);
            return result;
        }

        public static FVector4 operator *(FVector4 v2, FMatrix4x4 v1) {
            Multiply(ref v1, ref v2, out var result);
            return result;
        }

        public static FVector3 operator *(FMatrix4x4 v1, FVector3 v2) {
            TransformPoint(ref v1, ref v2, out var result);
            return result;
        }

        public static FVector3 operator *(FVector3 v2, FMatrix4x4 v1) {
            TransformPoint(ref v1, ref v2, out var result);
            return result;
        }

#if UNITY
        public static implicit operator UnityEngine.Matrix4x4(FMatrix4x4 mt)
        {
        ...
        public static implicit operator FMatrix4x4(UnityEngine.Matrix4x4 mt)
        {

...
public class ScriptsCreatorEditor : EditorWindow {
    ...
    private const string ComponentTemplatePath = "Assets/Editor/ScriptTemplates/EcsComponentTemplate.cs.txt";
    private const string SystemTemplatePath = "Assets/Editor/ScriptTemplates/EcsSystemTemplate.cs.txt";
    private const string AuthoringTemplatePath = "Assets/Editor/ScriptTemplates/EcsAuthoringTemplate.cs.txt";
    ...
    private static void CreateEcsScriptsKit() {
        ...
        _window = GetWindow<ScriptsCreatorEditor>();
        _window.Show();
    }
...
internal class NameByEnterOrUnfocus : EndNameEditAction {
    ...
    private static Object CreateScript(string pathName, string resourceFile) {
        ...
        // 正则替换文本内自定义的变量
        var scriptText = Regex.Replace(templateText, "#NAME#", ScriptsCreatorEditor.createName);

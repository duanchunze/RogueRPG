...
namespace Hsenl.MultiCombiner {
    public class StatusPriorityStateCombiner : MultiCombiner<Status, PriorityState> {
        protected override void OnCombin(Status arg1, PriorityState arg2) {
            ...
            arg2.onEnter += this.EnqueueAction<Action<IPrioritizer>>((manager) => { arg1.OnBegin(); });
            arg2.onUpdate += this.EnqueueAction<Action<IPrioritizer, float>>((manager, deltaTime) => { arg1.OnUpdate(deltaTime); });

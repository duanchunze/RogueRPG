...
namespace Hsenl.Mono {
    public class CardStoreComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.CardStore> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.CardStore _hsenlComponent;
    
        public Hsenl.CardStore HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.CardStore;

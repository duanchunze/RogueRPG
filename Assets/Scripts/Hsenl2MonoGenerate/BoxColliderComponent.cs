...
namespace Hsenl.Mono {
    public class BoxColliderComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.BoxCollider> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.BoxCollider _hsenlComponent;
    
        public Hsenl.BoxCollider HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.BoxCollider;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(BoxColliderComponent))]
    public class BoxColliderComponentEditor : OdinEditor {
        private BoxColliderComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (BoxColliderComponent)this.target;
        }

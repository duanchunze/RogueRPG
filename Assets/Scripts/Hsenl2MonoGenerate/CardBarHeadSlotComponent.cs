...
namespace Hsenl.Mono {
    public class CardBarHeadSlotComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.CardBarHeadSlot> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.CardBarHeadSlot _hsenlComponent;
    
        public Hsenl.CardBarHeadSlot HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.CardBarHeadSlot;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(CardBarHeadSlotComponent))]
    public class CardBarHeadSlotComponentEditor : OdinEditor {
        private CardBarHeadSlotComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (CardBarHeadSlotComponent)this.target;
        }

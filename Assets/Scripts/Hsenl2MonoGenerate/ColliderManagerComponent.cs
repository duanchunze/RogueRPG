...
namespace Hsenl.Mono {
    public class ColliderManagerComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.ColliderManager> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.ColliderManager _hsenlComponent;
    
        public Hsenl.ColliderManager HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.ColliderManager;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(ColliderManagerComponent))]
    public class ColliderManagerComponentEditor : OdinEditor {
        private ColliderManagerComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (ColliderManagerComponent)this.target;
        }

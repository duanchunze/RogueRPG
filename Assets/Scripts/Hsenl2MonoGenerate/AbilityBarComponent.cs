...
namespace Hsenl.Mono {
    public class AbilityBarComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.AbilityBar> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.AbilityBar _hsenlComponent;
    
        public Hsenl.AbilityBar HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.AbilityBar;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(AbilityBarComponent))]
    public class AbilityBarComponentEditor : OdinEditor {
        private AbilityBarComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (AbilityBarComponent)this.target;
        }

...
namespace Hsenl.Mono {
    public class StatusBarComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.StatusBar> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.StatusBar _hsenlComponent;
    
        public Hsenl.StatusBar HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.StatusBar;

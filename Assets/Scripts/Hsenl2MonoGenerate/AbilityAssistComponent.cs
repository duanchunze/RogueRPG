...
namespace Hsenl.Mono {
    public class AbilityAssistComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.AbilityAssist> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.AbilityAssist _hsenlComponent;
    
        public Hsenl.AbilityAssist HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.AbilityAssist;

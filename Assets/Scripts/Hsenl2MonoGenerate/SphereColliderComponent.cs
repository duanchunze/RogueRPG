...
namespace Hsenl.Mono {
    public class SphereColliderComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.SphereCollider> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.SphereCollider _hsenlComponent;
    
        public Hsenl.SphereCollider HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.SphereCollider;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(SphereColliderComponent))]
    public class SphereColliderComponentEditor : OdinEditor {
        private SphereColliderComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (SphereColliderComponent)this.target;
        }

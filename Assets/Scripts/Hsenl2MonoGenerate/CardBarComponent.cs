...
namespace Hsenl.Mono {
    public class CardBarComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.CardBar> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.CardBar _hsenlComponent;
    
        public Hsenl.CardBar HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.CardBar;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(CardBarComponent))]
    public class CardBarComponentEditor : OdinEditor {
        private CardBarComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (CardBarComponent)this.target;
        }

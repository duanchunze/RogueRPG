...
namespace Hsenl.Mono {
    public class TransformComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Transform> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.Transform _hsenlComponent;
    
        public Hsenl.Transform HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.Transform;

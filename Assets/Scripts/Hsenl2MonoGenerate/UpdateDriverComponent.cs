...
namespace Hsenl.Mono {
    public class UpdateDriverComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.UpdateDriver> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.UpdateDriver _hsenlComponent;
    
        public Hsenl.UpdateDriver HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.UpdateDriver;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(UpdateDriverComponent))]
    public class UpdateDriverComponentEditor : OdinEditor {
        private UpdateDriverComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (UpdateDriverComponent)this.target;
        }

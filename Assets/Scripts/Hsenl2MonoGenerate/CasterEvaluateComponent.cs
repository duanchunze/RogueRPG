...
namespace Hsenl.Mono {
    public class CasterEvaluateComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.CasterEvaluate> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.CasterEvaluate _hsenlComponent;
    
        public Hsenl.CasterEvaluate HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.CasterEvaluate;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(CasterEvaluateComponent))]
    public class CasterEvaluateComponentEditor : OdinEditor {
        private CasterEvaluateComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (CasterEvaluateComponent)this.target;
        }

...
namespace Hsenl.Mono {
    public class UnbodiedHeadComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.UnbodiedHead> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.UnbodiedHead _hsenlComponent;
    
        public Hsenl.UnbodiedHead HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.UnbodiedHead;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(UnbodiedHeadComponent))]
    public class UnbodiedHeadComponentEditor : OdinEditor {
        private UnbodiedHeadComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (UnbodiedHeadComponent)this.target;
        }

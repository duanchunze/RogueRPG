...
namespace Hsenl.Mono {
    public class ProcedureLineComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.ProcedureLine> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.ProcedureLine _hsenlComponent;
    
        public Hsenl.ProcedureLine HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.ProcedureLine;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(ProcedureLineComponent))]
    public class ProcedureLineComponentEditor : OdinEditor {
        private ProcedureLineComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (ProcedureLineComponent)this.target;
        }

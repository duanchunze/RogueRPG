...
namespace Hsenl.Mono {
    public class UnlockCircumstanceComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.UnlockCircumstance> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.UnlockCircumstance _hsenlComponent;
    
        public Hsenl.UnlockCircumstance HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.UnlockCircumstance;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(UnlockCircumstanceComponent))]
    public class UnlockCircumstanceComponentEditor : OdinEditor {
        private UnlockCircumstanceComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (UnlockCircumstanceComponent)this.target;
        }

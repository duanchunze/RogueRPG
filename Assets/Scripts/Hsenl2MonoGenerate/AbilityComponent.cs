...
namespace Hsenl.Mono {
    public class AbilityComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Ability> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.Ability _hsenlComponent;
    
        public Hsenl.Ability HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.Ability;
    ...
    public class AbilityComponentEditor : OdinEditor {
        private AbilityComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (AbilityComponent)this.target;
        }

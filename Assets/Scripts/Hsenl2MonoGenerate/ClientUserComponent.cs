...
namespace Hsenl.Mono {
    public class ClientUserComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.ClientUser> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.ClientUser _hsenlComponent;
    
        public Hsenl.ClientUser HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.ClientUser;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(ClientUserComponent))]
    public class ClientUserComponentEditor : OdinEditor {
        private ClientUserComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (ClientUserComponent)this.target;
        }

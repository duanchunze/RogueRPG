...
namespace Hsenl.Mono {
    public class CardComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Card> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.Card _hsenlComponent;
    
        public Hsenl.Card HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.Card;

...
namespace Hsenl.Mono {
    public class SelectorComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Selector> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.Selector _hsenlComponent;
    
        public Hsenl.Selector HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.Selector;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(SelectorComponent))]
    public class SelectorComponentEditor : OdinEditor {
        private SelectorComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (SelectorComponent)this.target;
        }

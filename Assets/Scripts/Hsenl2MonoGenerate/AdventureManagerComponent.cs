...
namespace Hsenl.Mono {
    public class AdventureManagerComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.AdventureManager> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.AdventureManager _hsenlComponent;
    
        public Hsenl.AdventureManager HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.AdventureManager;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(AdventureManagerComponent))]
    public class AdventureManagerComponentEditor : OdinEditor {
        private AdventureManagerComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (AdventureManagerComponent)this.target;
        }

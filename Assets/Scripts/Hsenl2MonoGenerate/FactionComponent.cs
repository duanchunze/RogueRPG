...
namespace Hsenl.Mono {
    public class FactionComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Faction> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.Faction _hsenlComponent;
    
        public Hsenl.Faction HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.Faction;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(FactionComponent))]
    public class FactionComponentEditor : OdinEditor {
        private FactionComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (FactionComponent)this.target;
        }

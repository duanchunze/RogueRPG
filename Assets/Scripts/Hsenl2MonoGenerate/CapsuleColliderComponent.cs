...
namespace Hsenl.Mono {
    public class CapsuleColliderComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.CapsuleCollider> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.CapsuleCollider _hsenlComponent;
    
        public Hsenl.CapsuleCollider HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.CapsuleCollider;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(CapsuleColliderComponent))]
    public class CapsuleColliderComponentEditor : OdinEditor {
        private CapsuleColliderComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (CapsuleColliderComponent)this.target;
        }

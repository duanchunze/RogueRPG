...
namespace Hsenl.Mono {
    public class PrioritizerComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Prioritizer> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.Prioritizer _hsenlComponent;
    
        public Hsenl.Prioritizer HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.Prioritizer;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(PrioritizerComponent))]
    public class PrioritizerComponentEditor : OdinEditor {
        private PrioritizerComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (PrioritizerComponent)this.target;
        }

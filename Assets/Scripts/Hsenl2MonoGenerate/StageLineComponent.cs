...
namespace Hsenl.Mono {
    public class StageLineComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.StageLine> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.StageLine _hsenlComponent;
    
        public Hsenl.StageLine HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.StageLine;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(StageLineComponent))]
    public class StageLineComponentEditor : OdinEditor {
        private StageLineComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (StageLineComponent)this.target;
        }

...
namespace Hsenl.Mono {
    public class IrregularColliderComponent : MonoBehaviour, IHsenlComponentReference<IrregularCollider> {
        [SerializeField]
        private IrregularCollider _hsenlComponent;
    
        public IrregularCollider HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = (IrregularCollider)reference;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(IrregularColliderComponent))]
    public class IrregularColliderComponentEditor : OdinEditor {
        private IrregularColliderComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (IrregularColliderComponent)this.target;
        }

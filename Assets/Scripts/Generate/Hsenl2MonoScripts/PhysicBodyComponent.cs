...
namespace Hsenl.Mono {
    public class PhysicBodyComponent : MonoBehaviour, IHsenlComponentReference<PhysicBody> {
        [SerializeField]
        private PhysicBody _hsenlComponent;
    
        public PhysicBody HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = (PhysicBody)reference;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(PhysicBodyComponent))]
    public class PhysicBodyComponentEditor : OdinEditor {
        private PhysicBodyComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (PhysicBodyComponent)this.target;
        }

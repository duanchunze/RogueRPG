...
public sealed partial class CardSynthesisConfig :  Bright.Config.BeanBase 
{
    public CardSynthesisConfig(JSONNode _json) 
    {
    ...
    public CardSynthesisConfig(int id, System.Collections.Generic.List<string> synthesis_members, string synthesis_achievement ) 
    {
        this.Id = id;
    ...
    public static CardSynthesisConfig DeserializeCardSynthesisConfig(JSONNode _json)
    {
        return new card.CardSynthesisConfig(_json);
    }
    ...
    public const int __ID__ = -2011910456;

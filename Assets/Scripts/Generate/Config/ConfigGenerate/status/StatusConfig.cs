...
public sealed partial class StatusConfig :  Bright.Config.BeanBase 
{
    ...
    public StatusConfig(int id, string alias, string view_name, string desc, float duration, System.Collections.Generic.List<numeric.AttachValueInfo> numeric_nodes, System.Collections.Generic.List<TagType> tags, priority.StateInfo priority_state, status.StatusActionInfo main ) 
    {
        this.Id = id;
        this.Alias = alias;

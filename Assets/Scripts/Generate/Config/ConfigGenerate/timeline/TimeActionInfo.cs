...
public abstract partial class TimeActionInfo :  timeline.TimeLineInfo 
{
    public TimeActionInfo(JSONNode _json)  : base(_json) 
    {
        PostInit();
    }

    public TimeActionInfo()  : base() 
    {
        PostInit();
    }

    public static TimeActionInfo DeserializeTimeActionInfo(JSONNode _json)
    {

...
public sealed partial class HarmOfSphereColliderInfo :  timeline.TsHarmInfo 
{
    ...
    public HarmOfSphereColliderInfo(int model, float origin, float dest, numeric.DamageFormulaInfo harm_formula, string hit_fx, string hit_sound )  : base(model,origin,dest) 
    {

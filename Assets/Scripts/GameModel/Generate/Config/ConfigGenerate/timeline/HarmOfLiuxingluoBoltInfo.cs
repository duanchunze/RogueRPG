...
public sealed partial class HarmOfLiuxingluoBoltInfo :  timeline.TpHarmInfo 
{
    public HarmOfLiuxingluoBoltInfo(JSONNode _json)  : base(_json) 
    {
    ...
    public HarmOfLiuxingluoBoltInfo(int model, float point, numeric.DamageFormulaInfo harm_formula, string bolt_config_alias, float speed )  : base(model,point) 
    {
    ...
    public static HarmOfLiuxingluoBoltInfo DeserializeHarmOfLiuxingluoBoltInfo(JSONNode _json)
    {
        return new timeline.HarmOfLiuxingluoBoltInfo(_json);
    }
    ...
    public const int __ID__ = 568224063;

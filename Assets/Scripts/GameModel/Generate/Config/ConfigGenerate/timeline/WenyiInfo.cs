...
public sealed partial class WenyiInfo :  timeline.TsStatusHarmInfo 
{
    public WenyiInfo(JSONNode _json)  : base(_json) 
    {
    ...
    public WenyiInfo(int model, float origin, float dest, numeric.DamageFormulaInfo harm_formula, float internalTime )  : base(model,origin,dest) 
    {
    ...
    public static WenyiInfo DeserializeWenyiInfo(JSONNode _json)
    {
        return new timeline.WenyiInfo(_json);
    }
    ...
    public const int __ID__ = -1544663631;

...
/// 最常用的属性数值配方
/// </summary>
public sealed partial class FormulaInfo1 :  numeric.FormulaInfo 
{
    public FormulaInfo1(JSONNode _json)  : base(_json) 
    {
    ...
    public FormulaInfo1(NumericType type, float pct, int fix )  : base() 
    {
        this.Type = type;
        this.Pct = pct;
        this.Fix = fix;
    ...
    public static FormulaInfo1 DeserializeFormulaInfo1(JSONNode _json)
    {
        return new numeric.FormulaInfo1(_json);
    }
    ...
    public const int __ID__ = -1775542050;

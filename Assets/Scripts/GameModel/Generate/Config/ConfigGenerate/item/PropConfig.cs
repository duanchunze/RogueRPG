...
public sealed partial class PropConfig :  Bright.Config.BeanBase 
{
    ...
    public PropConfig(int id, string alias, System.Collections.Generic.List<TagType> tags, System.Collections.Generic.List<numeric.AttachValueInfo> numeric_nodes ) 
    {
        this.Id = id;
        this.Alias = alias;
        this.Tags = tags;
    ...
    {
        return new item.PropConfig(_json);
    }
    ...
    public const int __ID__ = 1515758176;

...
/// 添加一个自定义的状态
/// </summary>
public sealed partial class AdditionalStatusOnAbilityDamageInfo2 :  procedureline.WorkerInfo 
{
    public AdditionalStatusOnAbilityDamageInfo2(JSONNode _json)  : base(_json) 
    {
    ...
    public AdditionalStatusOnAbilityDamageInfo2(string status_alias, float duration, timeline.TimeActionInfo action )  : base() 
    {
    ...
    public static AdditionalStatusOnAbilityDamageInfo2 DeserializeAdditionalStatusOnAbilityDamageInfo2(JSONNode _json)
    {
        return new procedureline.AdditionalStatusOnAbilityDamageInfo2(_json);
    }
    ...
    public const int __ID__ = -1230809910;

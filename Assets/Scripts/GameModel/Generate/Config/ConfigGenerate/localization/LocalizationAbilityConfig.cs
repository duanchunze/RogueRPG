...
public sealed partial class LocalizationAbilityConfig :  Bright.Config.BeanBase 
{
    ...
    public LocalizationAbilityConfig(int id, string alias, System.Collections.Generic.Dictionary<string, string> name, System.Collections.Generic.Dictionary<string, string> desc ) 
    {
        this.Id = id;
        this.Alias = alias;
        this.Name = name;

...
{
    public LocalizationPropConfig(JSONNode _json) 
    {
    ...
    public LocalizationPropConfig(string alias, System.Collections.Generic.Dictionary<string, string> name, System.Collections.Generic.Dictionary<string, string> desc ) 
    {
        this.Alias = alias;
        this.Name = name;
        this.Desc = desc;
    ...
    public static LocalizationPropConfig DeserializeLocalizationPropConfig(JSONNode _json)
    {
        return new localization.LocalizationPropConfig(_json);
    }
    ...
    public const int __ID__ = -761346285;

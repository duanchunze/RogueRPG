...
//             foreach (var card in this.FindBodiedsInIndividual<Card>()) {
...
//             foreach (var cardSlot in this.FindBodiedsInIndividual<TSlot>()) {
...
//             EventStation.OnCardResidenceUpdated(this);
//             try {

...
//                 }
//
//                 case WrappageAbilityPatchInfo wrappageAbilityPatchInfo: {
//                     var abilityPatchConfig = Tables.Instance.TbAbilityPatchConfig.GetByAlias(wrappageAbilityPatchInfo.Alias);
//                     var entity = Entity.Create(config.Alias);
//                     var card = entity.AddComponent<Card>();
//                     card.cardId = config.Id;
//                     card.cardType.Add(CardType.AbilityPatch);
//                     card.Wrap(AbilityPatchFactory.Create(abilityPatchConfig));
//                     return card;
//                 }
//
//                 default:

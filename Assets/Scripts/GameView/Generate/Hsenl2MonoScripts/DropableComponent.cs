...
namespace Hsenl.Mono {
    public class DropableComponent : MonoBehaviour, IHsenlComponentReference<Dropable> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Dropable _hsenlComponent;
    
        public Dropable HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Dropable;

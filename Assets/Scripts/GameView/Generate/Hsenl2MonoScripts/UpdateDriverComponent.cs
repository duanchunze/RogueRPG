...
namespace Hsenl.Mono {
    public class UpdateDriverComponent : MonoBehaviour, IHsenlComponentReference<UpdateDriver> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private UpdateDriver _hsenlComponent;
    
        public UpdateDriver HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as UpdateDriver;

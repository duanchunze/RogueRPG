...
namespace Hsenl.Mono {
    public class PrioritizerComponent : MonoBehaviour, IHsenlComponentReference<Prioritizer> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Prioritizer _hsenlComponent;
    
        public Prioritizer HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Prioritizer;

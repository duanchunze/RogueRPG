...
namespace Hsenl.Mono {
    public class ElementComponent : MonoBehaviour, IHsenlComponentReference<Element> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Element _hsenlComponent;
    
        public Element HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Element;

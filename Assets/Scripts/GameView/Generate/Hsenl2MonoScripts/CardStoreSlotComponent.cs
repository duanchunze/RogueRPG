...
namespace Hsenl.Mono {
    public class CardStoreSlotComponent : MonoBehaviour, IHsenlComponentReference<CardStoreSlot> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private CardStoreSlot _hsenlComponent;
    
        public CardStoreSlot HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as CardStoreSlot;

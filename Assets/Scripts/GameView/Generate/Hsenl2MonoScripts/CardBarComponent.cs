...
namespace Hsenl.Mono {
    public class CardBarComponent : MonoBehaviour, IHsenlComponentReference<CardBar> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private CardBar _hsenlComponent;
    
        public CardBar HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as CardBar;

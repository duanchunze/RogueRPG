...
namespace Hsenl.Mono {
    public class BehaviorTreeComponent : MonoBehaviour, IHsenlComponentReference<BehaviorTree> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private BehaviorTree _hsenlComponent;
    
        public BehaviorTree HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as BehaviorTree;

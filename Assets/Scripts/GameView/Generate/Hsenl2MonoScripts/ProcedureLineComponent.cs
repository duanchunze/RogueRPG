...
namespace Hsenl.Mono {
    public class ProcedureLineComponent : MonoBehaviour, IHsenlComponentReference<ProcedureLine> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private ProcedureLine _hsenlComponent;
    
        public ProcedureLine HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as ProcedureLine;

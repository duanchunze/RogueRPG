...
namespace Hsenl.Mono {
    public class BoxColliderComponent : MonoBehaviour, IHsenlComponentReference<BoxCollider> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private BoxCollider _hsenlComponent;
    
        public BoxCollider HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as BoxCollider;

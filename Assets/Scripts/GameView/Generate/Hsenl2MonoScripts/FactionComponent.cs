...
namespace Hsenl.Mono {
    public class FactionComponent : MonoBehaviour, IHsenlComponentReference<Faction> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Faction _hsenlComponent;
    
        public Faction HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Faction;

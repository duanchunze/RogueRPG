...
namespace Hsenl.Mono {
    public class StageLineComponent : MonoBehaviour, IHsenlComponentReference<StageLine> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private StageLine _hsenlComponent;
    
        public StageLine HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as StageLine;

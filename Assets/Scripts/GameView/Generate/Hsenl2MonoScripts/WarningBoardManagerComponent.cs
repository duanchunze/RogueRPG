...
namespace Hsenl.Mono {
    public class WarningBoardManagerComponent : MonoBehaviour, IHsenlComponentReference<WarningBoardManager> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private WarningBoardManager _hsenlComponent;
    
        public WarningBoardManager HsenlComponent => this._hsenlComponent;

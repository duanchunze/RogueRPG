...
namespace Hsenl.Mono {
    public class CasterEvaluateComponent : MonoBehaviour, IHsenlComponentReference<CasterEvaluate> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private CasterEvaluate _hsenlComponent;
    
        public CasterEvaluate HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as CasterEvaluate;

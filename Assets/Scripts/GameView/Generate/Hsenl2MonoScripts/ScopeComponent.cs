...
namespace Hsenl.Mono {
    public class ScopeComponent : MonoBehaviour, IHsenlComponentReference<Scope> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Scope _hsenlComponent;
    
        public Scope HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Scope;

...
namespace Hsenl.Mono {
    public class AdventureManagerComponent : MonoBehaviour, IHsenlComponentReference<AdventureManager> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private AdventureManager _hsenlComponent;
    
        public AdventureManager HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as AdventureManager;

...
namespace Hsenl.Mono {
    public class BoltManagerComponent : MonoBehaviour, IHsenlComponentReference<BoltManager> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private BoltManager _hsenlComponent;
    
        public BoltManager HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as BoltManager;

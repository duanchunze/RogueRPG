...
namespace Hsenl.Mono {
    public class QuestComponent : MonoBehaviour, IHsenlComponentReference<Quest> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Quest _hsenlComponent;
    
        public Quest HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Quest;

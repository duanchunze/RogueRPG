...
namespace Hsenl.Mono {
    public class BodiedComponent : MonoBehaviour, IHsenlComponentReference<Bodied> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Bodied _hsenlComponent;
    
        public Bodied HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Bodied;

...
namespace Hsenl.Mono {
    public class TaskLineComponent : MonoBehaviour, IHsenlComponentReference<TaskLine> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private TaskLine _hsenlComponent;
    
        public TaskLine HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as TaskLine;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(TaskLineComponent))]
    public class TaskLineComponentEditor : OdinEditor {
        private TaskLineComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (TaskLineComponent)this.target;
        }

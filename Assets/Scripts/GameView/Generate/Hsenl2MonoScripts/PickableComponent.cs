...
namespace Hsenl.Mono {
    public class PickableComponent : MonoBehaviour, IHsenlComponentReference<Pickable> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Pickable _hsenlComponent;
    
        public Pickable HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Pickable;

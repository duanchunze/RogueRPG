...
namespace Hsenl.Mono {
    public class AdventureComponent : MonoBehaviour, IHsenlComponentReference<Adventure> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Adventure _hsenlComponent;
    
        public Adventure HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Adventure;

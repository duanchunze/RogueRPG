...
namespace Hsenl.Mono {
    public class TimeLineComponent : MonoBehaviour, IHsenlComponentReference<TimeLine> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private TimeLine _hsenlComponent;
    
        public TimeLine HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as TimeLine;

...
namespace Hsenl.Mono {
    public class CardBarHeadSlotComponent : MonoBehaviour, IHsenlComponentReference<CardBarHeadSlot> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private CardBarHeadSlot _hsenlComponent;
    
        public CardBarHeadSlot HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as CardBarHeadSlot;

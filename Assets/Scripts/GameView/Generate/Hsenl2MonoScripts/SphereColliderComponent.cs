...
namespace Hsenl.Mono {
    public class SphereColliderComponent : MonoBehaviour, IHsenlComponentReference<SphereCollider> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private SphereCollider _hsenlComponent;
    
        public SphereCollider HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as SphereCollider;

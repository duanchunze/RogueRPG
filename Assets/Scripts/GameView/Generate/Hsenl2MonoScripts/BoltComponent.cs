...
namespace Hsenl.Mono {
    public class BoltComponent : MonoBehaviour, IHsenlComponentReference<Bolt> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Bolt _hsenlComponent;
    
        public Bolt HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Bolt;

...
namespace Hsenl.Mono {
    public class ControlTriggerComponent : MonoBehaviour, IHsenlComponentReference<ControlTrigger> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private ControlTrigger _hsenlComponent;
    
        public ControlTrigger HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as ControlTrigger;

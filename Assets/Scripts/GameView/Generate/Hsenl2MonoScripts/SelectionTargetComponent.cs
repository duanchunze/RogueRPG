...
namespace Hsenl.Mono {
    public class SelectionTargetComponent : MonoBehaviour, IHsenlComponentReference<SelectionTarget> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private SelectionTarget _hsenlComponent;
    
        public SelectionTarget HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as SelectionTarget;

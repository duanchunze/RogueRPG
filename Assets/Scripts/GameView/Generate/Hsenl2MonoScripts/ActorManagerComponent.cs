...
namespace Hsenl.Mono {
    public class ActorManagerComponent : MonoBehaviour, IHsenlComponentReference<ActorManager> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private ActorManager _hsenlComponent;
    
        public ActorManager HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as ActorManager;

...
namespace Hsenl.Mono {
    public class CardBackpackSlotComponent : MonoBehaviour, IHsenlComponentReference<CardBackpackSlot> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private CardBackpackSlot _hsenlComponent;
    
        public CardBackpackSlot HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as CardBackpackSlot;

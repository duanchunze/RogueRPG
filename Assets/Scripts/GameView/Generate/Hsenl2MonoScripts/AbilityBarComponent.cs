...
namespace Hsenl.Mono {
    public class AbilityBarComponent : MonoBehaviour, IHsenlComponentReference<AbilityBar> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private AbilityBar _hsenlComponent;
    
        public AbilityBar HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as AbilityBar;

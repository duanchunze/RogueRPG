...
namespace Hsenl.Mono {
    public class ControlComponent : MonoBehaviour, IHsenlComponentReference<Control> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Control _hsenlComponent;
    
        public Control HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Control;

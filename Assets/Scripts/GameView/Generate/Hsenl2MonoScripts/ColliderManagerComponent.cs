...
namespace Hsenl.Mono {
    public class ColliderManagerComponent : MonoBehaviour, IHsenlComponentReference<ColliderManager> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private ColliderManager _hsenlComponent;
    
        public ColliderManager HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as ColliderManager;

...
namespace Hsenl.Mono {
    public class RigidbodyComponent : MonoBehaviour, IHsenlComponentReference<Rigidbody> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Rigidbody _hsenlComponent;
    
        public Rigidbody HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Rigidbody;

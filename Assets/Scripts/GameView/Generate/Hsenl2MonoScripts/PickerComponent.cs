...
namespace Hsenl.Mono {
    public class PickerComponent : MonoBehaviour, IHsenlComponentReference<Picker> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Picker _hsenlComponent;
    
        public Picker HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Picker;

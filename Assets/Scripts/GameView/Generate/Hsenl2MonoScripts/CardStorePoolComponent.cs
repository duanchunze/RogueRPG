...
namespace Hsenl.Mono {
    public class CardStorePoolComponent : MonoBehaviour, IHsenlComponentReference<CardStorePool> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private CardStorePool _hsenlComponent;
    
        public CardStorePool HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as CardStorePool;

...
namespace Hsenl.Mono {
    public class SelectorComponent : MonoBehaviour, IHsenlComponentReference<Selector> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Selector _hsenlComponent;
    
        public Selector HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Selector;

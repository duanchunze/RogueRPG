...
namespace Hsenl.Mono {
    public class AbilityComponent : MonoBehaviour, IHsenlComponentReference<Ability> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Ability _hsenlComponent;
    
        public Ability HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Ability;

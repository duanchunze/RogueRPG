...
namespace Hsenl.Mono {
    public class CollisionEventListenerComponent : MonoBehaviour, IHsenlComponentReference<CollisionEventListener> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private CollisionEventListener _hsenlComponent;
    
        public CollisionEventListener HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as CollisionEventListener;

...
namespace Hsenl.Mono {
    public class ProcedureLineNodeComponent : MonoBehaviour, IHsenlComponentReference<ProcedureLineNode> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private ProcedureLineNode _hsenlComponent;
    
        public ProcedureLineNode HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as ProcedureLineNode;

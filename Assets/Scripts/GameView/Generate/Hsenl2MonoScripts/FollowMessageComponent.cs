...
namespace Hsenl.Mono {
    public class FollowMessageComponent : MonoBehaviour, IHsenlComponentReference<FollowMessage> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private FollowMessage _hsenlComponent;
    
        public FollowMessage HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as FollowMessage;

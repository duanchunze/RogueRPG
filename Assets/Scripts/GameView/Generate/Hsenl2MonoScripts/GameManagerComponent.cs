...
namespace Hsenl.Mono {
    public class GameManagerComponent : MonoBehaviour, IHsenlComponentReference<GameManager> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private GameManager _hsenlComponent;
    
        public GameManager HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as GameManager;

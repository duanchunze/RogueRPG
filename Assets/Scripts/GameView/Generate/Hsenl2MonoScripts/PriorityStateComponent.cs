...
namespace Hsenl.Mono {
    public class PriorityStateComponent : MonoBehaviour, IHsenlComponentReference<PriorityState> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private PriorityState _hsenlComponent;
    
        public PriorityState HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as PriorityState;

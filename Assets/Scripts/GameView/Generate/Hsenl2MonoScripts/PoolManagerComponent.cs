...
namespace Hsenl.Mono {
    public class PoolManagerComponent : MonoBehaviour, IHsenlComponentReference<PoolManager> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private PoolManager _hsenlComponent;
    
        public PoolManager HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as PoolManager;

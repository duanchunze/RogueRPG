...
namespace Hsenl.Mono {
    public class HurtableComponent : MonoBehaviour, IHsenlComponentReference<Hurtable> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hurtable _hsenlComponent;
    
        public Hurtable HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hurtable;

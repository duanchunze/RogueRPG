...
namespace Hsenl.Mono {
    public class CardBarAssistSlotComponent : MonoBehaviour, IHsenlComponentReference<CardBarAssistSlot> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private CardBarAssistSlot _hsenlComponent;
    
        public CardBarAssistSlot HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as CardBarAssistSlot;

...
namespace Hsenl.Mono {
    public class UnlockCircumstanceComponent : MonoBehaviour, IHsenlComponentReference<UnlockCircumstance> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private UnlockCircumstance _hsenlComponent;
    
        public UnlockCircumstance HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as UnlockCircumstance;

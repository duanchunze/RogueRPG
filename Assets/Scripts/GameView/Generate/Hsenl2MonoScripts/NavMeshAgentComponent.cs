...
namespace Hsenl.Mono {
    public class NavMeshAgentComponent : MonoBehaviour, IHsenlComponentReference<NavMeshAgent> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private NavMeshAgent _hsenlComponent;
    
        public NavMeshAgent HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as NavMeshAgent;

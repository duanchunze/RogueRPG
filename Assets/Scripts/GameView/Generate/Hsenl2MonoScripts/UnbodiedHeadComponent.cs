...
namespace Hsenl.Mono {
    public class UnbodiedHeadComponent : MonoBehaviour, IHsenlComponentReference<UnbodiedHead> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private UnbodiedHead _hsenlComponent;
    
        public UnbodiedHead HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as UnbodiedHead;

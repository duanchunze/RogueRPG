...
namespace Hsenl.Mono {
    public class StatusComponent : MonoBehaviour, IHsenlComponentReference<Status> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Status _hsenlComponent;
    
        public Status HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Status;

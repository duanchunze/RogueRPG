...
namespace Hsenl.Mono {
    public class CardBarSlotComponent : MonoBehaviour, IHsenlComponentReference<CardBarSlot> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private CardBarSlot _hsenlComponent;
    
        public CardBarSlot HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as CardBarSlot;

...
namespace Hsenl.Mono {
    public class MotionComponent : MonoBehaviour, IHsenlComponentReference<Motion> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Motion _hsenlComponent;
    
        public Motion HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Motion;

...
namespace Hsenl.Mono {
    public class ActorComponent : MonoBehaviour, IHsenlComponentReference<Actor> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Actor _hsenlComponent;
    
        public Actor HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Actor;

...
namespace Hsenl.Mono {
    public class CapsuleColliderComponent : MonoBehaviour, IHsenlComponentReference<CapsuleCollider> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private CapsuleCollider _hsenlComponent;
    
        public CapsuleCollider HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as CapsuleCollider;

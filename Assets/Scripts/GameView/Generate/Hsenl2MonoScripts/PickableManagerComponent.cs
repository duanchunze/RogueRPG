...
namespace Hsenl.Mono {
    public class PickableManagerComponent : MonoBehaviour, IHsenlComponentReference<PickableManager> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private PickableManager _hsenlComponent;
    
        public PickableManager HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as PickableManager;

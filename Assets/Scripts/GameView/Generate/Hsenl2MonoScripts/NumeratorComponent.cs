...
namespace Hsenl.Mono {
    public class NumeratorComponent : MonoBehaviour, IHsenlComponentReference<Numerator> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Numerator _hsenlComponent;
    
        public Numerator HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Numerator;

...
namespace Hsenl.Mono {
    public class HarmableComponent : MonoBehaviour, IHsenlComponentReference<Harmable> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Harmable _hsenlComponent;
    
        public Harmable HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Harmable;

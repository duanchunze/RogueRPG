...
namespace Hsenl.Mono {
    public class HeadInfoComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.View.HeadInfo> {
        [ReadOnly]
    ...
    #if UNITY_EDITOR
    [CustomEditor(typeof(HeadInfoComponent))]
    public class HeadInfoComponentEditor : OdinEditor {
        private HeadInfoComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (HeadInfoComponent)this.target;
        }

...
namespace Hsenl.Mono {
    public class AdventureComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Adventure> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.Adventure _hsenlComponent;
    
        public Hsenl.Adventure HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.Adventure;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(AdventureComponent))]
    public class AdventureComponentEditor : OdinEditor {
        private AdventureComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (AdventureComponent)this.target;
        }

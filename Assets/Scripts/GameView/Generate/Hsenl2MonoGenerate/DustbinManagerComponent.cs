...
namespace Hsenl.Mono {
    public class DustbinManagerComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.DustbinManager> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.DustbinManager _hsenlComponent;
    
        public Hsenl.DustbinManager HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.DustbinManager;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(DustbinManagerComponent))]
    public class DustbinManagerComponentEditor : OdinEditor {
        private DustbinManagerComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (DustbinManagerComponent)this.target;
        }

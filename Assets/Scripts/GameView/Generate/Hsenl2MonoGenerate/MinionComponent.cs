...
namespace Hsenl.Mono {
    public class MinionComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Minion> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.Minion _hsenlComponent;
    
        public Hsenl.Minion HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.Minion;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(MinionComponent))]
    public class MinionComponentEditor : OdinEditor {
        private MinionComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (MinionComponent)this.target;
        }

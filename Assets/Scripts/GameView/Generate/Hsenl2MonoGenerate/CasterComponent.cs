...
namespace Hsenl.Mono {
    public class CasterComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Caster> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.Caster _hsenlComponent;
    
        public Hsenl.Caster HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.Caster;

...
namespace Hsenl.Mono {
    public class CardStoreSlotComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.CardStoreSlot> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.CardStoreSlot _hsenlComponent;
    
        public Hsenl.CardStoreSlot HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.CardStoreSlot;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(CardStoreSlotComponent))]
    public class CardStoreSlotComponentEditor : OdinEditor {
        private CardStoreSlotComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (CardStoreSlotComponent)this.target;
        }

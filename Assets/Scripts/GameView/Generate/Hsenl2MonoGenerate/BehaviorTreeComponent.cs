...
namespace Hsenl.Mono {
    public class BehaviorTreeComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.BehaviorTree> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.BehaviorTree _hsenlComponent;
    
        public Hsenl.BehaviorTree HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.BehaviorTree;
    ...
    public class BehaviorTreeComponentEditor : OdinEditor {
        private BehaviorTreeComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (BehaviorTreeComponent)this.target;
        }

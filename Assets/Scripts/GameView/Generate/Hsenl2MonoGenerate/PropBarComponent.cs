...
namespace Hsenl.Mono {
    public class PropBarComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.PropBar> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.PropBar _hsenlComponent;
    
        public Hsenl.PropBar HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.PropBar;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(PropBarComponent))]
    public class PropBarComponentEditor : OdinEditor {
        private PropBarComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (PropBarComponent)this.target;
        }

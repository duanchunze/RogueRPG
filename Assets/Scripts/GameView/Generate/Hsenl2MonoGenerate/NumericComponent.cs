...
namespace Hsenl.Mono {
    public class NumericComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Numeric> {
        [ReadOnly]
    ...
    #if UNITY_EDITOR
    [CustomEditor(typeof(NumericComponent))]
    public class NumericComponentEditor : OdinEditor {
        private NumericComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (NumericComponent)this.target;
        }

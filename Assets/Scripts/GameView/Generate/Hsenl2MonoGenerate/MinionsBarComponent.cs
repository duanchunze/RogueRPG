...
namespace Hsenl.Mono {
    public class MinionsBarComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.MinionsBar> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.MinionsBar _hsenlComponent;
    
        public Hsenl.MinionsBar HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.MinionsBar;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(MinionsBarComponent))]
    public class MinionsBarComponentEditor : OdinEditor {
        private MinionsBarComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (MinionsBarComponent)this.target;
        }

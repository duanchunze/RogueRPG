...
namespace Hsenl.Mono {
    public class PropComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Prop> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.Prop _hsenlComponent;
    
        public Hsenl.Prop HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.Prop;
    ...
    public class PropComponentEditor : OdinEditor {
        private PropComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (PropComponent)this.target;
        }

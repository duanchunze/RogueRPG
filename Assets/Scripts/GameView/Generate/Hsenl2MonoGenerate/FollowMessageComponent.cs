...
namespace Hsenl.Mono {
    public class FollowMessageComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.View.FollowMessage> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.View.FollowMessage _hsenlComponent;
    
        public Hsenl.View.FollowMessage HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.View.FollowMessage;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(FollowMessageComponent))]
    public class FollowMessageComponentEditor : OdinEditor {
        private FollowMessageComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (FollowMessageComponent)this.target;
        }

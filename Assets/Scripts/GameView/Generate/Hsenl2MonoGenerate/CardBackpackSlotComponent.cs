...
namespace Hsenl.Mono {
    public class CardBackpackSlotComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.CardBackpackSlot> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.CardBackpackSlot _hsenlComponent;
    
        public Hsenl.CardBackpackSlot HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.CardBackpackSlot;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(CardBackpackSlotComponent))]
    public class CardBackpackSlotComponentEditor : OdinEditor {
        private CardBackpackSlotComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (CardBackpackSlotComponent)this.target;
        }

...
namespace Hsenl.Mono {
    public class SelectorFlagComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.View.SelectorFlag> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.View.SelectorFlag _hsenlComponent;
    
        public Hsenl.View.SelectorFlag HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.View.SelectorFlag;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(SelectorFlagComponent))]
    public class SelectorFlagComponentEditor : OdinEditor {
        private SelectorFlagComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (SelectorFlagComponent)this.target;
        }

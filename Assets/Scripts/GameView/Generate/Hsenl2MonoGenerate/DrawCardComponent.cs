...
namespace Hsenl.Mono {
    public class DrawCardComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.DrawCard> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.DrawCard _hsenlComponent;
    
        public Hsenl.DrawCard HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.DrawCard;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(DrawCardComponent))]
    public class DrawCardComponentEditor : OdinEditor {
        private DrawCardComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (DrawCardComponent)this.target;
        }

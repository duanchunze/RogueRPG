...
namespace Hsenl.Mono {
    public class AppearanceComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Appearance> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.Appearance _hsenlComponent;
    
        public Hsenl.Appearance HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.Appearance;

...
namespace Hsenl.Mono {
    public class ModelComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.View.Model> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.View.Model _hsenlComponent;
    
        public Hsenl.View.Model HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.View.Model;
    ...
    public class ModelComponentEditor : OdinEditor {
        private ModelComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (ModelComponent)this.target;
        }

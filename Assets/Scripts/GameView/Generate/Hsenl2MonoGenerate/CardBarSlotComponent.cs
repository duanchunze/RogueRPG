...
namespace Hsenl.Mono {
    public class CardBarSlotComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.CardBarSlot> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.CardBarSlot _hsenlComponent;
    
        public Hsenl.CardBarSlot HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.CardBarSlot;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(CardBarSlotComponent))]
    public class CardBarSlotComponentEditor : OdinEditor {
        private CardBarSlotComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (CardBarSlotComponent)this.target;
        }

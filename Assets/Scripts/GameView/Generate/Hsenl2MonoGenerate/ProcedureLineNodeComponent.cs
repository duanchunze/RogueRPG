...
namespace Hsenl.Mono {
    public class ProcedureLineNodeComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.ProcedureLineNode> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.ProcedureLineNode _hsenlComponent;
    
        public Hsenl.ProcedureLineNode HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.ProcedureLineNode;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(ProcedureLineNodeComponent))]
    public class ProcedureLineNodeComponentEditor : OdinEditor {
        private ProcedureLineNodeComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (ProcedureLineNodeComponent)this.target;
        }

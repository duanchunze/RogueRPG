...
namespace Hsenl.Mono {
    public class CardBarAssistSlotComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.CardBarAssistSlot> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.CardBarAssistSlot _hsenlComponent;
    
        public Hsenl.CardBarAssistSlot HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.CardBarAssistSlot;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(CardBarAssistSlotComponent))]
    public class CardBarAssistSlotComponentEditor : OdinEditor {
        private CardBarAssistSlotComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (CardBarAssistSlotComponent)this.target;
        }

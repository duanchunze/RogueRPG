...
namespace Hsenl.Mono {
    public class AbilityTraitComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.AbilityTrait> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.AbilityTrait _hsenlComponent;
    
        public Hsenl.AbilityTrait HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.AbilityTrait;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(AbilityTraitComponent))]
    public class AbilityTraitComponentEditor : OdinEditor {
        private AbilityTraitComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (AbilityTraitComponent)this.target;
        }

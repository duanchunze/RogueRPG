...
namespace Hsenl.Mono {
    public class AbilityPatchComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.AbilityPatch> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.AbilityPatch _hsenlComponent;
    
        public Hsenl.AbilityPatch HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.AbilityPatch;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(AbilityPatchComponent))]
    public class AbilityPatchComponentEditor : OdinEditor {
        private AbilityPatchComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (AbilityPatchComponent)this.target;
        }

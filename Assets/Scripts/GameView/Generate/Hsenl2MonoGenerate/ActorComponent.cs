...
namespace Hsenl.Mono {
    public class ActorComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Actor> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.Actor _hsenlComponent;
    
        public Hsenl.Actor HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.Actor;
    ...
    public class ActorComponentEditor : OdinEditor {
        private ActorComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (ActorComponent)this.target;
        }

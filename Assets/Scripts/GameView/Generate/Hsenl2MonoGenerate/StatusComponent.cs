...
namespace Hsenl.Mono {
    public class StatusComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Status> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.Status _hsenlComponent;
    
        public Hsenl.Status HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.Status;
    ...
    public class StatusComponentEditor : OdinEditor {
        private StatusComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (StatusComponent)this.target;
        }

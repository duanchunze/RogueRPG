...
namespace Hsenl.Mono {
    public class SelectionTargetComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.SelectionTarget> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.SelectionTarget _hsenlComponent;
    
        public Hsenl.SelectionTarget HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.SelectionTarget;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(SelectionTargetComponent))]
    public class SelectionTargetComponentEditor : OdinEditor {
        private SelectionTargetComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (SelectionTargetComponent)this.target;
        }

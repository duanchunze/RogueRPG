...
namespace Hsenl.Mono {
    public class AbilitesBarComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.AbilitesBar> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.AbilitesBar _hsenlComponent;
    
        public Hsenl.AbilitesBar HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.AbilitesBar;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(AbilitesBarComponent))]
    public class AbilitesBarComponentEditor : OdinEditor {
        private AbilitesBarComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (AbilitesBarComponent)this.target;
        }

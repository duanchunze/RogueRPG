...
namespace Hsenl.Mono {
    public class SelectorDefaultComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.SelectorDefault> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.SelectorDefault _hsenlComponent;
    
        public Hsenl.SelectorDefault HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.SelectorDefault;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(SelectorDefaultComponent))]
    public class SelectorDefaultComponentEditor : OdinEditor {
        private SelectorDefaultComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (SelectorDefaultComponent)this.target;
        }

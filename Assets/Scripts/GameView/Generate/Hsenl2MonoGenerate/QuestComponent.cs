...
namespace Hsenl.Mono {
    public class QuestComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Quest> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.Quest _hsenlComponent;
    
        public Hsenl.Quest HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.Quest;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(QuestComponent))]
    public class QuestComponentEditor : OdinEditor {
        private QuestComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (QuestComponent)this.target;
        }

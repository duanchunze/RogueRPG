...
namespace Hsenl.Mono {
    public class ElementComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.Element> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.Element _hsenlComponent;
    
        public Hsenl.Element HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.Element;
    ...
    public class ElementComponentEditor : OdinEditor {
        private ElementComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (ElementComponent)this.target;
        }

...
namespace Hsenl.Mono {
    public class SelectionTargetDefaultComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.SelectionTargetDefault> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.SelectionTargetDefault _hsenlComponent;
    
        public Hsenl.SelectionTargetDefault HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.SelectionTargetDefault;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(SelectionTargetDefaultComponent))]
    public class SelectionTargetDefaultComponentEditor : OdinEditor {
        private SelectionTargetDefaultComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (SelectionTargetDefaultComponent)this.target;
        }

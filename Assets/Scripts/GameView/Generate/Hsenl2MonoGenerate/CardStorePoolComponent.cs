...
namespace Hsenl.Mono {
    public class CardStorePoolComponent : MonoBehaviour, IHsenlComponentReference<Hsenl.CardStorePool> {
        [ReadOnly]
        public int hsenlComponentInstanceId;
    
        [SerializeField]
        private Hsenl.CardStorePool _hsenlComponent;
    
        public Hsenl.CardStorePool HsenlComponent => this._hsenlComponent;
        ...
        void IHsenlComponentReference.SetFrameworkReference(Component reference) {
            this._hsenlComponent = reference as Hsenl.CardStorePool;
            this.hsenlComponentInstanceId = this._hsenlComponent?.InstanceId??0;
        }
    }
    
    #if UNITY_EDITOR
    [CustomEditor(typeof(CardStorePoolComponent))]
    public class CardStorePoolComponentEditor : OdinEditor {
        private CardStorePoolComponent _t;

        protected override void OnEnable() {
            base.OnEnable();
            this._t = (CardStorePoolComponent)this.target;
        }
